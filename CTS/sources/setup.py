...
setup(
    ...
    packages=['main',
              ...
              'tests_packages.Rack_Scale_2_3_POD_Manager.required',
              'tests_packages.Rack_Scale_2_3_PSME.required',
              'tests_packages.Rack_Scale_2_3_RMM.required',
              'tests_packages.Rack_Scale_2_3_Storage_Services.required',
    ...
    package_data={'cts_framework.actions.status.results_formatters.html_static_files': ['*'],
                  ...
                  'tests_packages.Rack_Scale_2_3_POD_Manager.required': ['*.py'],
                  'tests_packages.Rack_Scale_2_3_PSME.required': ['*.py'],
                  'tests_packages.Rack_Scale_2_3_RMM.required': ['*.py'],
                  'tests_packages.Rack_Scale_2_3_Storage_Services.required': ['*.py'],
