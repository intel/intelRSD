...
from cts_core.metadata.metadata_constants import MetadataConstants_RMM_2_3 as MetadataConstants
...
@RegisterService(ServiceTypes.RMM_2_3)
class ValidatePatchResponses(CtsTestScript):
    ...
    def run(self):
        ...
        validator = MetadataPatchValidator(self.metadata_container, self.configuration,
                                           PatchingStrategy2_3(), requirements)
