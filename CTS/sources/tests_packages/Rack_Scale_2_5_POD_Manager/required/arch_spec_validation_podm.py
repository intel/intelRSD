...
class ArchSpecValidation(CtsTestScript):
    ...
    def run(self):
        ...
        discovery_container, status = api_explorer.discover(MetadataConstants.SERVICE_ROOT_URI, MetadataConstants.SERVICE_ROOT)
        catalog = expanduser("~") + "/.cts/tests/Rack_Scale_2_5_POD_Manager/required/tests_archeo_podm/"
