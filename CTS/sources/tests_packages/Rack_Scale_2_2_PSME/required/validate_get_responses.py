...
from cts_core.metadata.required_types import RequiredTypes_PSME_2_2
...
def SkipCheckPredicate_PSME_2_2(discovery_container, requirement):
...
@RegisterService(ServiceTypes.PSME_2_2)
class ValidateGetResponses(CtsTestScript):
    ...
    def run(self):
        ...
        MetadataGetValidator(self.metadata_container, RequiredTypes_PSME_2_2,
                             skip_check_predicate=SkipCheckPredicate_PSME_2_2).validate(discovery_container)
