...
from cts_core.metadata.metadata_constants import MetadataConstants2_3 as MetadataConstants
from cts_core.metadata.required_types import RequiredTypes_PODM_2_3
...
def SkipCheckPredicate_PODM_2_3(discovery_container, requirement):
...
@RegisterService(ServiceTypes.PODM_2_3)
class ValidateGetResponses(CtsTestScript):
    ...
    def run(self):
        ...
        MetadataGetValidator(self.metadata_container, RequiredTypes_PODM_2_3,
                             skip_check_predicate=SkipCheckPredicate_PODM_2_3).validate(discovery_container)
