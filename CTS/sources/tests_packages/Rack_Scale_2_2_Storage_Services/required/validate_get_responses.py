...
from cts_core.metadata.required_types import RequiredTypes_Storage_2_2
...
@RegisterService(ServiceTypes.SS_2_2)
class ValidateGetResponses(CtsTestScript):
    ...
    def run(self):
        ...
        MetadataGetValidator(self.metadata_container, RequiredTypes_Storage_2_2).validate(discovery_container)
