...
from cts_core.metadata.metadata_constants import MetadataConstants_RMM_2_4 as MetadataConstants
from cts_core.validation.patch.metadata_patch_validator import MetadataPatchValidator
from cts_core.validation.patch.patching_strategy_2_4 import PatchingStrategy2_4
...
@RegisterService(ServiceTypes.RMM_2_4)
class ValidatePatchResponses(CtsTestScript):
    ...
    def run(self):
        ...
        validator = MetadataPatchValidator(self.metadata_container, self.configuration,
                                           PatchingStrategy2_4(), requirements,
