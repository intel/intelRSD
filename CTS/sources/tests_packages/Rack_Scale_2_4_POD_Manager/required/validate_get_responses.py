...
from cts_core.metadata.required_types import RequiredTypes_PODM_2_4
...
def skip_check_predicate_podm_2_4(discovery_container, requirement):
    if requirement.base in [MetadataConstants.MEMORY, MetadataConstants.PROCESSOR,
        ...
        num_virtual_systems = len(discovery_container.get_resources(MetadataConstants.COMPUTER_SYSTEM,
                                                                    ...
                                                                    constraints=[equal("SystemType", "Virtual")]))
        return (num_systems > 0 and num_systems == num_virtual_systems)


@RegisterService(ServiceTypes.PODM_2_4)
class ValidateGetResponses(CtsTestScript):
    ...
    def run(self):
        ...
        MetadataGetValidator(self.metadata_container, RequiredTypes_PODM_2_4,
                             skip_check_predicate=skip_check_predicate_podm_2_4).validate(discovery_container)
