...
from cts_core.metadata.required_types import RequiredTypes_PSME_2_1
...
class ValidateGetResponses(CtsTestScript):
    ...
    def run(self):
        ...
        MetadataGetValidator(self.metadata_container, RequiredTypes_PSME_2_1).validate(discovery_container)
