...
from cts_core.metadata.metadata_constants import MetadataConstants1_2 as MetadataConstants
from cts_core.metadata.required_types import RequiredTypes_PODM_2_1
...
class ValidateGetResponses(CtsTestScript):
    ...
    def run(self):
        ...
        MetadataGetValidator(self.metadata_container, RequiredTypes_PODM_2_1).validate(discovery_container)
