/*!
 * @brief FPGAoF Fabric discoverer interface.
 *
 ...
 *
 * @file fpgaof_fabric_discoverer.hpp
 */
#pragma once
...
class FpgaofFabricDiscoverer : public agent_framework::discovery::FabricDiscoverer {
public:

    /*! Destructor */
    virtual ~FpgaofFabricDiscoverer() {}
