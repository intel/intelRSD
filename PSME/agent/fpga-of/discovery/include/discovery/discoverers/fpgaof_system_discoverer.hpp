...
public:
     ...
     */
    explicit FpgaofSystemDiscoverer(std::shared_ptr<sysfs::AbstractSysfsInterface> sysfs) : m_sysfs(sysfs) {}


    /*! Virtual destructor */
    virtual ~FpgaofSystemDiscoverer() {}
     ...
     * */
    virtual agent_framework::model::System discover(const Uuid& parent_uuid, const Uuid& chassis_uuid);
