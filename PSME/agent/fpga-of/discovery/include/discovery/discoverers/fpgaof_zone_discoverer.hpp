/*!
 * @brief FPGAoF Zone discoverer interface.
 *
 ...
 *
 * @file fpgaof_zone_discoverer.hpp
 */
#pragma once
...
class FpgaofZoneDiscoverer : public agent_framework::discovery::ZoneDiscoverer {
public:
     ...
     */
    FpgaofZoneDiscoverer(AgentContext::SPtr context) : m_context(context) {}


    /*! Virtual destructor */
    virtual ~FpgaofZoneDiscoverer() {}
