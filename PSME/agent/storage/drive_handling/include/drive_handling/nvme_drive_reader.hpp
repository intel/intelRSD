 ...
 */
class NvmeDriveReader : public BaseDriveReader {
public:
     ...
     */
    NvmeDriveReader(std::shared_ptr<sysfs::AbstractSysfsInterface> sysfs_interface)
        : m_sysfs_interface(sysfs_interface) {}

    /*!
     * @brief virtual Destructor
     */
    virtual ~NvmeDriveReader();
