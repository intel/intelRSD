...
public:
    ...
    static const KeyType generate_key(const T& resource, const Args&... args);
...
protected:
     ...
     * */
    template<class T>
    static const KeyType generate_key_base(const T& resource) {
        return m_keys_base_map.at(resource.get_component());
    }
