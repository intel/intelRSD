 ...
 *
 * @file storage_agent_commands.hpp
 */
...
#define REGISTER_STORAGE_COMMAND(CMD, FUNC) REGISTER_CONTEXT_COMMAND(AgentContext, CMD, FUNC)
...
using DeleteTask = ::agent_framework::command::ContextDeleteTask<AgentContext>;
