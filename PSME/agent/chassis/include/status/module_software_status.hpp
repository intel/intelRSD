...
#ifndef AGENT_CHASSIS_STATUS_MODULE_SOFTWARE_STATUS_HPP
#define AGENT_CHASSIS_STATUS_MODULE_SOFTWARE_STATUS_HPP
...
#endif /* AGENT_CHASSIS_STATUS_MODULE_SOFTWARE_STATUS_HPP */
