...
#ifndef AGENT_CHASSIS_IPMB_COMMAND_UNKNOWN_COMMAND_HPP
#define AGENT_CHASSIS_IPMB_COMMAND_UNKNOWN_COMMAND_HPP
...
#endif /* AGENT_CHASSIS_IPMB_COMMAND_UNKNOWN_COMMAND_HPP */
