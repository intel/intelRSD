 ...
 *
 * @brief SystemBuilder implementation
 * */
...
void SystemBuilder::build_default() {
    ...
    m_obj.set_system_type(enums::SystemType::Virtual);
...
SystemBuilder::ReturnType SystemBuilder::update_links(const std::string& chassis_uuid) {
