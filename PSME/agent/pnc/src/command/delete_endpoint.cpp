...
REGISTER_COMMAND(DeleteEndpoint,
    [] (const DeleteEndpoint::Request&, DeleteEndpoint::Response&) {
        THROW(agent_framework::exceptions::NotImplemented, "pnc-gami",
            "DeleteEndpoint command is not not supported in the current implementation!");
    }
);
