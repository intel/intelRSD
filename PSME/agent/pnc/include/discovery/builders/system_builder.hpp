...
/*!
 * @brief Builder used to create system objects
 */
class SystemBuilder : public AbstractBuilder<agent_framework::model::System> {

public:

    using ReturnType = SystemBuilder&;
