/*!
 * @brief Add QoS application protocol command class definition.
 *
 ...
 *
 * @file add_switch_qos_application_protocol.cpp
 */
...
std::vector<std::string> AddSwitchQosApplicationProtocol::serialize() const {
    ...
    commands.push_back("dcbx application " + protocol_type.at(m_protocol) + " " + std::to_string(m_port) +
                       " priority " + std::to_string(m_priority));
    return commands;
}

AddSwitchQosApplicationProtocol::~AddSwitchQosApplicationProtocol() { }