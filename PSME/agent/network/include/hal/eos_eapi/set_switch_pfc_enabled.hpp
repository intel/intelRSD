/*!
 * @brief Set switch PFC enabled command class declaration.
 *
 ...
 *
 * @file set_switch_pfc_enabled.hpp
 */
...
/*!
 * @brief Class representing eapi Set Switch PFC command
 */
class SetSwitchPfcEnabled : public EapiCommand {
public:
     ...
     */
    SetSwitchPfcEnabled(bool state)
        : EapiCommand{EAPI_COMMAND_JSON}, m_state{state} { }

    /*! Destructor */
    virtual ~SetSwitchPfcEnabled();
