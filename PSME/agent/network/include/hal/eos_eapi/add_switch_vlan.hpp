/*!
 * @brief Add Switch Vlan command class declaration.
 *
...
/*!
 * @brief Class representing eAPI Add Switch Vlan command
 */
class AddSwitchVlan : public EapiCommand {
public:
     ...
     */
    AddSwitchVlan(std::uint32_t vlan_id)
        : EapiCommand{EAPI_COMMAND_JSON},
          m_vlan_id{vlan_id} { }

    /*! Destructor */
    virtual ~AddSwitchVlan();
