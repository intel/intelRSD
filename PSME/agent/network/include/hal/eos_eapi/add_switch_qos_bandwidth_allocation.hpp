/*!
 * @brief Add QoS bandwidth allocation command class declaration.
 *
 ...
 *
 * @file add_switch_qos_bandwidth_allocation.hpp
 */
...
/*!
 * @brief Class representing eAPI Add QoS Bandwidth Allocation command
 */
class AddSwitchQosBandwidthAllocation : public EapiCommand {
public:
     ...
     */
    AddSwitchQosBandwidthAllocation(std::uint32_t bandwidth_percent, std::uint32_t priority_group)
        : EapiCommand{EAPI_COMMAND_JSON},
          m_bandwidth_percent{bandwidth_percent}, m_priority_group{priority_group} { }

    /*! Destructor */
    virtual ~AddSwitchQosBandwidthAllocation();
