...
#include "api/netlink/vlan_info.hpp"
...
class InfoVlanPortMessage final : public agent::network::api::netlink::LinkMessage {
public:
    using VlanInfo = agent::network::api::netlink::VlanInfo;
