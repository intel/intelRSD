...
/*!
 * @brief LLDP argument message header class
 * */
class ArgMessageHeader final : public MessageHeader {
public:
    /*! Default constructor */
    explicit ArgMessageHeader() = default;
     ...
     *
     * */
    explicit ArgMessageHeader(const std::string& arg);
