...
#ifndef AGENT_NETWORK_STATUS_MODULE_SOFTWARE_STATUS_HPP
#define AGENT_NETWORK_STATUS_MODULE_SOFTWARE_STATUS_HPP
...
#endif /* AGENT_NETWORK_STATUS_MODULE_SOFTWARE_STATUS_HPP */
