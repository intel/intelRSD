 ...
 * @file system.hpp
 *
 * @brief ipmi-way of discovering system
 * */
...
/*!
 * @brief Discovers system GUID using IPMI commands
 *
 ...
 */
std::tuple<bool, agent_framework::model::enums::Health> discover_system(ipmi::ManagementController& mc,
