/*!
 * @brief SPDK Storage pool discoverer interface.
 *
 ...
 *
 * @file spdk_storage_pool_discoverer.hpp
 */
...
class SpdkStoragePoolDiscoverer : public agent_framework::discovery::StoragePoolDiscoverer {
public:
     ...
     */
    SpdkStoragePoolDiscoverer(AgentContext::SPtr context) : m_context(context) {}


    /*! Virtual destructor */
    virtual ~SpdkStoragePoolDiscoverer() {}
