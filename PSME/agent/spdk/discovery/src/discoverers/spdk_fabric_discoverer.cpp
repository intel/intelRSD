/*!
 * @brief SPDK NVMe-oF fabric discoverer implementation.
 *
 ...
 *
 * @file spdk_fabric_discoverer.cpp
 */
...
agent_framework::model::Fabric SpdkFabricDiscoverer::discover(const Uuid& parent_uuid) {
    auto fabric = agent_framework::discovery::FabricDiscoverer::discover(parent_uuid);
    agent_framework::discovery::FabricBuilder::nvmeof_protocol(fabric);
    return fabric;
}
