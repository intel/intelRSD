...
void get_managers_collection(GetManagersCollection::ContextPtr,
    ...
    log_debug("fpga-discovery-agent", "Getting managers collection is successfully finished.");
}
}

REGISTER_FPGA_DISCOVERY_COMMAND(GetManagersCollection, ::get_managers_collection);
