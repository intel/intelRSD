/*!
 * @brief Definition of FpgaDatabase class.
 *
 ...
 *
 * @file fpga_discovery_database.hpp
 */
...
class FpgaDiscoveryDatabase : public Database {
public:
     ...
     */
    FpgaDiscoveryDatabase(const Uuid& uuid, const std::string& name);

    /*!
     * @brief Destructor
     */
    virtual ~FpgaDiscoveryDatabase();
