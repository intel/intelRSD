...
#include "psme/rest/endpoints/chassis/power_zone.hpp"
...
json::Value make_prototype() {
    ...
    r[Common::ODATA_TYPE] = "#Power.v1_0_0.Power";
...
endpoint::PowerZone::PowerZone(const std::string& path) : EndpointBase(path) {}
