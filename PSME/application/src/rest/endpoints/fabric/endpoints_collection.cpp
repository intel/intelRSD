...
json::Value make_prototype() {
    ...
    r[Common::NAME] = "PCIe Endpoint Collection";
...
[[noreturn]] void EndpointsCollection::post(const server::Request& request, server::Response&) {
    validators::JsonValidator::validate_request_body<rest::validators::schema::EndpointsCollectionPostSchema>(request);

    THROW(agent_framework::exceptions::NotImplemented, "rest",
          "POST on Endpoints is not supported by the current implementation.");
}
