...
const jsonrpc::ProcedureValidator& EndpointsCollectionPostSchema::EntitySchema::get_procedure() {
    static jsonrpc::ProcedureValidator procedure{
        ...
        constants::Common::IDENTIFIERS, VALID_OPTIONAL(VALID_NULLABLE(VALID_ARRAY_OF(VALID_ATTRIBUTE(IdentifierSchema)))),
        nullptr
    };
    return procedure;
}
...
const jsonrpc::ProcedureValidator& EndpointsCollectionPostSchema::OemSchema::RackScaleSchema::AuthSchema::get_procedure() {
    static jsonrpc::ProcedureValidator procedure{
        jsonrpc::PARAMS_BY_NAME,
...
const jsonrpc::ProcedureValidator& EndpointsCollectionPostSchema::LinksSchema::OemSchema::RackScaleSchema::get_procedure() {
    static jsonrpc::ProcedureValidator procedure{
        jsonrpc::PARAMS_BY_NAME,
        constants::Endpoint::INTERFACES, VALID_OPTIONAL(VALID_NULLABLE(VALID_ARRAY_OF(VALID_NULLABLE(VALID_ATTRIBUTE(SimpleObjectSchema))))),
        nullptr
    };
    return procedure;
}
...
const jsonrpc::ProcedureValidator& EndpointsCollectionPostSchema::get_procedure() {
    static jsonrpc::ProcedureValidator procedure{
        jsonrpc::PARAMS_BY_NAME,
        constants::Endpoint::ENDPOINT_PROTOCOL, VALID_OPTIONAL(VALID_ENUM(enums::StorageProtocol)),
        constants::Common::IDENTIFIERS, VALID_OPTIONAL(VALID_NULLABLE(VALID_ARRAY_OF(VALID_ATTRIBUTE(IdentifierSchema)))),
        constants::Endpoint::CONNECTED_ENTITIES, VALID_ARRAY_OF(VALID_ATTRIBUTE(EntitySchema)),
        constants::Endpoint::IP_TRANSPORT_DETAILS, VALID_OPTIONAL(VALID_NULLABLE(VALID_ARRAY_OF(VALID_ATTRIBUTE(IpTransportDetailSchema)))),
