...
/*!
 * A class representing the rest api Switch endpoint
 */
class Switch : public EndpointBase {
public:
     ...
     */
    explicit Switch(const std::string& path);

    /*!
     * @brief Switch class destructor
     */
    virtual ~Switch();
