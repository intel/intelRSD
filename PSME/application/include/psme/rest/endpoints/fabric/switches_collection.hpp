 ...
 *
 * @file switches_collection.hpp
 * @brief Switches endpoint
 * */
...
/*!
 * A class representing the rest api SwitchesCollection endpoint
 */
class SwitchesCollection : public EndpointBase {
public:
     ...
     */
    explicit SwitchesCollection(const std::string& path);

    /*!
     * @brief SwitchesCollection class destructor
     */
    virtual ~SwitchesCollection();
