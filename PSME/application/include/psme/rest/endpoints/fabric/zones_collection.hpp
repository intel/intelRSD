 ...
 *
 * @file zones_collection.hpp
 * @brief Zones endpoint
 * */
...
/*!
 * A class representing the rest api ZonesCollection endpoint
 */
class ZonesCollection : public EndpointBase {
public:
     ...
     */
    explicit ZonesCollection(const std::string& path);

    /*!
     * @brief ZonesCollection class destructor
     */
    virtual ~ZonesCollection();
