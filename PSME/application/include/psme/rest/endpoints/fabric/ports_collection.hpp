 ...
 *
 * @file ports_collection.hpp
 * @brief Ports endpoint
 * */
...
/*!
 * A class representing the rest api PortsCollection endpoint
 */
class PortsCollection : public EndpointBase {
public:
     ...
     */
    explicit PortsCollection(const std::string& path);

    /*!
     * @brief PortsCollection class destructor
     */
    virtual ~PortsCollection();
