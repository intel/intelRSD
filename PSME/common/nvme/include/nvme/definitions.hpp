...
static_assert(sizeof(LogPageSmart) == 512, "Incorrect size");
...
/*! Struct representing frimware log page */
...
static_assert(sizeof(LogPageFirmware) == 512, "Incorrect size");
...
struct NvmeCmd {
    ...
    union {
        ...
        // namespace attachement command fields
