/*!
 * @brief Session implementation for "serial-oem" communication interface.
 *
 * Implementation of communication over ipmitool's "serial-oem" interface. This class controls
 ...
 *
 * @file ipmitool/serial_ipmi_intf.hpp
 */
...
class SerialIpmiInterface: public ipmi::IpmiInterface {

public:
    SerialIpmiInterface(ConnectionData::ConstPtr connection_data);

    virtual ~SerialIpmiInterface();
