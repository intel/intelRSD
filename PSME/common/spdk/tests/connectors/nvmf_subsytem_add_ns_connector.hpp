 ...
 *
 * @file nvmf_subsystem_add_ns_connector.hpp
 */
...
class NvmfSubsystemAddNsConnector : public json_rpc::AbstractClientConnector {
public:
    static constexpr const char SUBSYSTEM_NQN[] = "nqn.2016-06.io.spdk:ns";

    /*! Constructor */
    NvmfSubsystemAddNsConnector();
