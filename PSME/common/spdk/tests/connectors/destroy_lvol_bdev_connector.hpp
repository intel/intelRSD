 ...
 *
 * @file destroy_lvol_bdev_connector.hpp
 */
...
class DestroyLvolBdevConnector : public json_rpc::AbstractClientConnector {
private:

    // Container for lvol_bdev.
    spdk::JsonOptional<model::Bdev> lvol_bdev;

public:

    DestroyLvolBdevConnector();
