 ...
 *
 * @file inflate_lvol_bdev_connector.hpp
 */
...
class InflateLvolBdevConnector : public json_rpc::AbstractClientConnector {

public:

    // Container for lvol_bdevs.
    static std::vector<model::Bdev> m_lvol_bdev;


    InflateLvolBdevConnector();
