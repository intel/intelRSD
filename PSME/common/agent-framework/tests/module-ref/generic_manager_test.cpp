...
public:
    ...
    TestObject(const std::string& agent_id,
               ...
               const std::string& data):
                m_uuid(uuid), m_agent_id(agent_id), m_id(id),
    ...
    const std::string& get_resource_hash() const { return m_resource_hash; }
    ...
    bool operator==(const TestObject& rhs) const {
        return (m_agent_id == rhs.m_agent_id && m_uuid == rhs.m_uuid &&
                ...
                m_resource_hash == rhs.m_resource_hash && m_data == rhs.m_data);
    }
