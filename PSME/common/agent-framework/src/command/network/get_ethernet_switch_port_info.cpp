 ...
 * @section DESCRIPTION
 *
 * @file command/network/get_ethernet_switch_port_info.cpp
 *
 * @brief Generic network command get ethernet switch port information
 * implementation
 * */
...
constexpr const char GetEthernetSwitchPortInfo::AGENT[];

constexpr const char GetEthernetSwitchPortInfo::TAG[];
