 ...
 *
 *
 * @file command/network/json/set_component_attributes.cpp
 * @brief Implementation of JSON SetComonentsAttributes command interface.
 * */

#include "agent-framework/command/network/json/set_component_attributes.hpp"
...
SetComponentAttributes::method(const Json::Value& params, Json::Value& result) {
    ...
    network::SetComponentAttributes::Request request{};
    network::SetComponentAttributes::Response response{};
