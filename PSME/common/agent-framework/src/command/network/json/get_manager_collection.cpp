...
#include "agent-framework/command/network/json/get_manager_collection.hpp"
...
void GetManagerCollection::method(const Json::Value&, Json::Value& result) {
    ...
    network::GetManagerCollection::Request request{};
    network::GetManagerCollection::Response response{};
