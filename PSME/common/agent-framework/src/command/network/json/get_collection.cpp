...
#include "agent-framework/command/network/json/get_collection.hpp"
...
void GetCollection::method(const Json::Value& params, Json::Value& result) {
        ...
        network::GetCollection::Request request{};
        network::GetCollection::Response response{};
        ...
        result = response.m_subcomponents.to_json();
}
