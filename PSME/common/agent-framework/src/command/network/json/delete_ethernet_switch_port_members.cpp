 ...
 *
 * @file command/network/json/delete_ethernet_switch_port_members.cpp
 *
 * @brief JSON command DeleteEthernetSwitchPortMembers implementation
 * */

#include "agent-framework/command/network/json/delete_ethernet_switch_port_members.hpp"
...
void DeleteEthernetSwitchPortMembers::method(const Json::Value& params,
    Json::Value& result) {
    Command* command = get_command();

    network::DeleteEthernetSwitchPortMembers::Request request{};
    network::DeleteEthernetSwitchPortMembers::Response response{};
...
void DeleteEthernetSwitchPortMembers::notification(const Json::Value&) { }

static CommandJson::Register<DeleteEthernetSwitchPortMembers> g;
