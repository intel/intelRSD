 ...
 *
 * @file command/network/get_remote_ethernet_switch_info.cpp
 * @brief Generic network command get remote ethernet switch information
 * implementation
 * */
...
constexpr const char GetRemoteEthernetSwitchInfo::AGENT[];

constexpr const char GetRemoteEthernetSwitchInfo::TAG[];
