 ...
 *
 *
 * @file command/chassis/json/set_component_attributes.cpp
 * @brief Implementation of JSON SetComonentsAttributes command interface.
 * */

#include "agent-framework/command/chassis/json/set_component_attributes.hpp"
...
SetComponentAttributes::method(const Json::Value& params, Json::Value& result) {
    ...
    chassis::SetComponentAttributes::Request request{};
    chassis::SetComponentAttributes::Response response{};
