 ...
 *
 *
 * @file command/compute/json/set_component_attributes.cpp
 * @brief Implementation of JSON SetComonentsAttributes command interface.
 * */

#include "agent-framework/command/compute/json/set_component_attributes.hpp"
...
SetComponentAttributes::method(const Json::Value& params, Json::Value& result) {
    ...
    compute::SetComponentAttributes::Request request{};
    compute::SetComponentAttributes::Response response{};
