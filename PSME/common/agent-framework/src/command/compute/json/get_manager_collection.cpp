...
#include "agent-framework/command/compute/json/get_manager_collection.hpp"
...
void GetManagerCollection::method(const Json::Value&, Json::Value& result) {
        ...
        compute::GetManagerCollection::Request request{};
        compute::GetManagerCollection::Response response{};
