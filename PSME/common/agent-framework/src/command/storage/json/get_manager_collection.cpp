...
#include "agent-framework/command/storage/json/get_manager_collection.hpp"
...
void GetManagerCollection::method(const Json::Value&, Json::Value& result) {
        ...
        storage::GetManagerCollection::Request request{};
        storage::GetManagerCollection::Response response{};
