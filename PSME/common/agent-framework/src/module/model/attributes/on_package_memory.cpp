...
#include "agent-framework/module/model/attributes/on_package_memory.hpp"
...
json::Json OnPackageMemory::to_json() const {
    json::Json json{};
...
OnPackageMemory OnPackageMemory::from_json(const json::Json& json) {
    OnPackageMemory processor_memory{};
