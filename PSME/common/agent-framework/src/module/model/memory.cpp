...
const enums::CollectionName Memory::collection_name =
...
Json::Value Memory::to_json() const {
    Json::Value result;
    ...
    result[literals::Memory::MEMORY_MODES] = get_memory_modes().to_json();
    ...
    result[literals::Memory::FIRMWARE_API_VERSION] =
                                                get_firmware_api_version();
    result[literals::Memory::MEMORY_CLASSES] =
...
Memory Memory::from_json(const Json::Value& json) {
    using namespace agent_framework::model::attribute;
    Memory memory;
    memory.set_status(attribute::Status::from_json(
        json[literals::Memory::STATUS]));
    memory.set_memory_type(
        json[literals::Memory::MEMORY_TYPE]);
    memory.set_device_type(
        json[literals::Memory::DEVICE_TYPE]);
    memory.set_module_type(
        json[literals::Memory::MODULE_TYPE]);
    memory.set_media(attribute::Array<enums::Media>::from_json(
        json[literals::Memory::MODULE_TYPE]));
    memory.set_memory_modes(attribute::Array<enums::MemoryMode>::from_json(
        json[literals::Memory::MEMORY_MODES]));
    ...
    memory.set_firmware_api_version(
        json[literals::Memory::FIRMWARE_API_VERSION]);
    memory.set_memory_classes(attribute::Array<enums::MemoryClass>::from_json(
        json[literals::Memory::MEMORY_CLASSES]));
    ...
    memory.set_allowed_speeds_mhz(attribute::Array<std::uint32_t>::from_json(
        json[literals::Memory::ALLOWED_SPEEDS_MHZ]));
    ...
    memory.set_location(attribute::MemoryLocation::from_json(
        json[literals::Memory::LOCATION]));
    memory.set_rank_count(json[literals::Memory::RANK_COUNT]);
    memory.set_error_correction(
        json[literals::Memory::ERROR_CORRECTION]);
    memory.set_regions(attribute::Array<attribute::Region>::from_json(
        json[literals::Memory::REGIONS]));
    memory.set_media(attribute::Array<enums::Media>::from_json(
        json[literals::Memory::MEDIA]));
