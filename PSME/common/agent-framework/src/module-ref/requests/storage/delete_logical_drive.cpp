 ...
 * @section DESCRIPTION
 *
 * @file requests/storage/delete_logical_drive.cpp
 *
 * @brief Storage command DeleteLogicalDrive implementation
 * */


#include "agent-framework/module-ref/requests/storage/delete_logical_drive.hpp"
