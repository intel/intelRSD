 ...
 * @section DESCRIPTION
 *
 * @file request/chassis/get_authorization_certificate.cpp
 *
 * @brief Chassis request get authorization certificate implementation
 * */

#include \
"agent-framework/module-ref/requests/chassis/get_authorization_certificate.hpp"
...
GetAuthorizationCertificate GetAuthorizationCertificate::from_json(
    ...
    return GetAuthorizationCertificate{
        json[AuthorizationCertificate::CERTIFICATE].asString()};
}
