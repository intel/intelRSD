 ...
 *
 *
 * @file responses/network/delete_vlan.cpp
 * @brief DeleteVlan response
 * */

#include "agent-framework/module-ref/responses/network/delete_vlan.hpp"
...
DeleteVlan DeleteVlan::from_json(const Json::Value& json) {
    return DeleteVlan{Oem::from_json(json[PortVlan::OEM])};
}
