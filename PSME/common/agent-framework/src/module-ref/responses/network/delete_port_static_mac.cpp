 ...
 * @brief DeletePortStaticMac response
 * */

#include "agent-framework/module-ref/responses/network/delete_port_static_mac.hpp"
...
DeletePortStaticMac::DeletePortStaticMac(Oem oem):
    m_oem{oem} {}
