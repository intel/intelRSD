...
#ifndef AGENT_FRAMEWORK_MODULE_UTILS_OPTIONAL_FIELD_HPP
#define AGENT_FRAMEWORK_MODULE_UTILS_OPTIONAL_FIELD_HPP
...
#endif /* AGENT_FRAMEWORK_MODULE_UTILS_OPTIONAL_FIELD_HPP */
