 ...
 *
 *
 * @brief serial_console
 * */

#ifndef AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_SERIAL_CONSOLE_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_SERIAL_CONSOLE_HPP
...
#endif /* AGENT_FRAMEWORK_MODULE_ATTRIBUTES_SERIAL_CONSOLE_HPP */
