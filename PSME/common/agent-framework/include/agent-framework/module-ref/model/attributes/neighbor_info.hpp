 ...
 * @brief Neighbor info
 * */
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_NEIGHBOR_INFO_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_NEIGHBOR_INFO_HPP
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_NEIGHBOR_INFO_HPP */
