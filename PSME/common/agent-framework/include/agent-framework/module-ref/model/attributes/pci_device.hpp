 ...
 * @brief PCI device
 * */
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_PCI_DEVICE_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_PCI_DEVICE_HPP
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_ATTRIBUTES_PCI_DEVICE_HPP */
