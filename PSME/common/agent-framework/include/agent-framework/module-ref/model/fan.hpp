 ...
 * */
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_FAN_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_FAN_HPP
...
public:
    explicit Fan(const std::string& parent_uuid = {});
    ~Fan();
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_FAN_HPP  */
