 ...
 *
 *
 * @brief SwitchPort model interface
 * */
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_SWITCH_PORT_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_SWITCH_PORT_HPP
...
/*! Switch Port */
class SwitchPort : public Resource {
    template<class T>
    using OptionalField = agent_framework::module::utils::OptionalField<T>;
public:
    explicit SwitchPort(const std::string& parent_uuid = {});
    ~SwitchPort();

    SwitchPort(const SwitchPort&) = default;
    SwitchPort& operator=(const SwitchPort&) = default;
    SwitchPort(SwitchPort&&) = default;
    SwitchPort& operator=(SwitchPort&&) = default;

    /*!
     * @brief construct an object of class SwitchPort from JSON
     *
     * @param json the Json::Value deserialized to object
     *
     * @return the newly constructed SwitchPort object
     */
    static SwitchPort from_json(const Json::Value& json);
    ...
    static const enums::CollectionName& get_collection_name() {
        return SwitchPort::collection_name;
    }
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_SWITCH_PORT_HPP */
