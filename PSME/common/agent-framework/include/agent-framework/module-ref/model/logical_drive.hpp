 ...
 * */
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_LOGICAL_DRIVE_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_LOGICAL_DRIVE_HPP
...
public:
     ...
     * */
    const OptionalField<enums::LogicalDriveType> get_type() const { return m_type; }
     ...
     * */
    const OptionalField<enums::LogicalDriveMode> get_mode() const { return m_mode; }
     /*!
     ...
     * */
    const OptionalField<std::string>& get_master() const { return m_master; }
     ...
     * */
    const OptionalField<bool>& get_bootable() const { return m_bootable; }
     ...
     * */
    const OptionalField<bool>& get_protected() const { return m_protected; }
     ...
     * */
    const OptionalField<bool>& get_snapshot() const { return m_snapshot; }

     /*!
     * @brief Set if the logical_drive is snapshot
     * @param[in] snapshot_flag LogicalDrive snapshot option
     * */
    void set_snapshot(const OptionalField<bool>& snapshot_flag) {
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_LOGICAL_DRIVE_HPP */
