...
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_THERMAL_ZONE_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_THERMAL_ZONE_HPP
...
public:
    ...
    explicit ThermalZone(const std::string& parent_uuid = {});
    ~ThermalZone();
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_THERMAL_ZONE_HPP */
