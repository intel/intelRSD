 ...
 * */
#ifndef AGENT_FRAMEWORK_MODULE_MODEL_AUTHORIZATION_CERTIFICATE_HPP
#define AGENT_FRAMEWORK_MODULE_MODEL_AUTHORIZATION_CERTIFICATE_HPP
...
public:
    explicit AuthorizationCertificate(const std::string& parent_uuid = {});
...
#endif /* AGENT_FRAMEWORK_MODULE_MODEL_AUTHORIZATION_CERTIFICATE_HPP */
