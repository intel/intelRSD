...
/*!
 * @brief Class consisting of literals for SwitchPort model objects
 */
class SwitchPort {
public:
    static constexpr const char PORT[] = "port";
...
/*!
 * @brief Class consisting of literals for PortVlan model objects
 */
class PortVlan {
public:
...
/*!
 * @brief Class consisting of literals for Switch model objects
 */
class Switch {
public:
    static constexpr const char SWITCH[] = "switch";
