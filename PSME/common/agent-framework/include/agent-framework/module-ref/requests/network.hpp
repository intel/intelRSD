...
#include "agent-framework/module-ref/requests/network/add_ethernet_switch_port_members.hpp"
...
#include "agent-framework/module-ref/requests/network/get_vlan_info.hpp"
#include "agent-framework/module-ref/requests/network/get_port_vlan_info.hpp"
#include "agent-framework/module-ref/requests/network/get_remote_ethernet_switch_info.hpp"
#include "agent-framework/module-ref/requests/network/get_ethernet_switch_info.hpp"
#include "agent-framework/module-ref/requests/network/get_ethernet_switch_port_info.hpp"
#include "agent-framework/module-ref/requests/network/delete_acl.hpp"
...
#include "agent-framework/module-ref/requests/network/add_acl_port.hpp"
#include "agent-framework/module-ref/requests/network/delete_acl_rule.hpp"
#include "agent-framework/module-ref/requests/network/delete_acl_port.hpp"
#include "agent-framework/module-ref/requests/network/get_port_static_mac_info.hpp"
#include "agent-framework/module-ref/requests/network/add_port_static_mac.hpp"
