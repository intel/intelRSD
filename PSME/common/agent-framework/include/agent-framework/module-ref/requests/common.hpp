...
#ifndef AGENT_FRAMEWORK_MODEL_REQUESTS_COMMON_HPP
#define AGENT_FRAMEWORK_MODEL_REQUESTS_COMMON_HPP
...
#include "agent-framework/module-ref/requests/common/get_manager_info.hpp"
#include "agent-framework/module-ref/requests/common/set_component_attributes.hpp"
#include "agent-framework/module-ref/requests/common/get_chassis_info.hpp"

#endif // AGENT_FRAMEWORK_MODEL_REQUESTS_COMMON_HPP
