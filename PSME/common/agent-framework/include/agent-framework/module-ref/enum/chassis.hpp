...
#ifndef AGENT_FRAMEWORK_MODEL_ENUM_CHASSIS_HPP
#define AGENT_FRAMEWORK_MODEL_ENUM_CHASSIS_HPP
 ...
 */
ENUM(ChassisType, uint32_t, Rack, Drawer, Module, Blade, Enclosure);
...
*/
ENUM(PlatformType, uint32_t, BDCA, BDCR, UNKNOWN);

/*!
 * @brief ENUM SerialConsoleSignalType for Manager class Serial Console subclass
 * member
 *
 */
...
/*!
 * @brief ENUM SerialConsoleParity for Manager class Serial Console subclass
 * member
 *
 */
...
/*!
 * @brief ENUM SerialConsoleFlowControl for Manager class Serial Console
 * subclass member
 *
 */
...
/*!
 * @brief ENUM SerialConsolePinOut for Manager class Serial Console subclass
 * member
 *
 */
...
#endif //AGENT_FRAMEWORK_MODEL_ENUM_CHASSIS_HPP
