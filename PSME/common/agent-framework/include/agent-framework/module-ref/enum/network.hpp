...
#ifndef AGENT_FRAMEWORK_MODEL_ENUM_NETWORK_HPP
#define AGENT_FRAMEWORK_MODEL_ENUM_NETWORK_HPP
...
/*!
 * @biref ENUM Switch role in the network
 */
...
#endif //AGENT_FRAMEWORK_MODEL_ENUM_NETWORK_HPP
