...
#ifndef AGENT_FRAMEWORK_MODEL_ENUM_PROCESSOR_INSTRUCTION_SET_HPP
#define AGENT_FRAMEWORK_MODEL_ENUM_PROCESSOR_INSTRUCTION_SET_HPP
...
public:
     ...
     * */
    enum ProcessorInstructionSetEnum : std::uint32_t{x86_64, x86, UNKNOWN};
    ...
    friend std::ostream&
    operator<<(std::ostream& out_stream, const ProcessorInstructionSet& in_enum) {
...
#endif // AGENT_FRAMEWORK_MODEL_ENUM_INSTRUCTION_SET_HPP
