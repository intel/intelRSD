...
/*!
 * @brief FpgaInterface enum for FPGA
 * */
class FpgaInterface {
public:
     ...
     * */
    enum FpgaInterfaceEnum : std::uint32_t {
        QPI,
        UPI,
        _2xPCIe_4,
        _4xPCIe_4,
     ...
     * */
    static FpgaInterface from_string(const std::string& string);
     ...
     * */
    constexpr FpgaInterface(FpgaInterfaceEnum value) : m_value(value) {}
     ...
     * @return Enum
     * */
    constexpr operator FpgaInterfaceEnum() const {
        return static_cast<FpgaInterfaceEnum>(m_value);
    }
    ...
    friend std::ostream& operator<<(std::ostream& out_stream, const FpgaInterface& in_enum) {
