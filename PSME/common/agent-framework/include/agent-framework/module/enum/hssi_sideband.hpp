...
public:
     ...
     * */
    enum HssiSidebandEnum : std::uint32_t {
        SPI,
        I2C_0,
        I2C_1,
        I2C
     ...
     * */
    static HssiSideband from_string(const std::string& string);
     ...
     * */
    constexpr HssiSideband(HssiSidebandEnum value) : m_value(value) {}
     ...
     * @return Enum
     * */
    constexpr operator HssiSidebandEnum() const {
        return static_cast<HssiSidebandEnum>(m_value);
    }
    ...
    friend std::ostream& operator<<(std::ostream& out_stream, const HssiSideband& in_enum) {
