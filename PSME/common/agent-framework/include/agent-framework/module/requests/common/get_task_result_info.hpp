/*!
 * @brief Definition of a class representing getTaskResultInfo command request
 *
 * @copyright
...
/*!
 * Class representing getTaskResultInfo GAMI request
 * */
class GetTaskResultInfo {
public:
    explicit GetTaskResultInfo(const std::string& task);
    ...
    static const jsonrpc::ProcedureValidator& get_procedure() {
        static const jsonrpc::ProcedureValidator procedure{
            ...
            jsonrpc::JSON_STRING,
            literals::Task::TASK, jsonrpc::JSON_STRING,
            nullptr
        };
        return procedure;
    }
