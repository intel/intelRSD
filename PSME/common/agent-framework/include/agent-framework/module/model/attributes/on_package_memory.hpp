 ...
 *
 *
 * @file on_package_memory.hpp
 * @brief OnPackageMemory attribute
 * */
...
public:
     ...
     */
    const OptionalField<enums::OnPackageMemoryType>& get_type() const {
        return m_type;
    }
     ...
     */
    void set_type(const OptionalField<enums::OnPackageMemoryType>& type) {
        m_type = type;
    }
    ...
    /*!
     * @brief construct an object of class OnPackageMemory from JSON
     *
     * @param json the json::Json deserialized to object
     *
     * @return the newly constructed OnPackageMemory object
     */
    static OnPackageMemory from_json(const json::Json& json);


    /*!
     * @brief Transform the object to JSon
     *
     * @return A OnPackageMemory object serialized to json::Json
     */
    json::Json to_json() const;


private:
    OptionalField<enums::OnPackageMemoryType> m_type{};
