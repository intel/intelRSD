 ...
 *
 *
 * @file responses/network/delete_port_static_mac.hpp
 * @brief Definition of network DeletePortStaticMac response
 * */
...
/*! DeletePortStaticMac request */
class DeletePortStaticMac  {
public:
    using Oem = agent_framework::model::attribute::Oem;

    /*!
     * @brief explicit DeletePortStaticMac response constructor
     *
     * @param[in] oem OEM specific data
     * */
    explicit DeletePortStaticMac(Oem oem = Oem{});
