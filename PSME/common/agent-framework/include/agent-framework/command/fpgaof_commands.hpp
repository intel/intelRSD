 ...
 *
 * @file fpgaof_commands.hpp
 *
 * @brief Declarations of all FPGA-oF commands
 * */
...
template <typename CONTEXT> using ContextGetProcessorInfo = ContextCommand<CONTEXT, model::requests::GetProcessorInfo, model::Processor>;
