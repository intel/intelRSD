...
#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_ISCSI_TARGET_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_ISCSI_TARGET_INFO_HPP
...
/*! @brief JSON getStorageControllerInfo class */
class GetIscsiTargetInfo : public CommandJson {
public:
    /*! @brief Agent tag string */
    static constexpr const char* AGENT = storage::GetIscsiTargetInfo::AGENT;

    /*! @brief Command name tag string */
    static constexpr const char* TAG = storage::GetIscsiTargetInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_ISCSI_TARGET_INFO_HPP */
