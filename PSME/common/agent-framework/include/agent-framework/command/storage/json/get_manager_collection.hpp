...
#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_MANAGER_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_MANAGER_COLLECTION_HPP

#include "agent-framework/command/command_json.hpp"
#include "agent-framework/command/storage/get_manager_collection.hpp"
...
public:
  /*! Agent tag string */
  static constexpr const char* AGENT = storage::GetManagerCollection::AGENT;

  /*! Command name tag string */
  static constexpr const char* TAG = storage::GetManagerCollection::TAG;
...
#endif /*! AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_MANAGER_COLLECTION_HPP */
