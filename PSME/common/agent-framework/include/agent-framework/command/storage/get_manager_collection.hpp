 ...
 *
 *
 * @file command/storage/get_manager_collection.hpp
 * @brief Generic storage GetManagerCollection command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_GET_MANAGER_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_GET_MANAGER_COLLECTION_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_STORAGE_GET_MANAGER_COLLECTION_HPP */
