...
#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MANAGER_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MANAGER_COLLECTION_HPP
...
public:
  /*! Agent tag string */
  static constexpr const char* AGENT = compute::GetManagerCollection::AGENT;

  /*! Command name tag string */
  static constexpr const char* TAG = compute::GetManagerCollection::TAG;
...
#endif /*! AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MANAGER_COLLECTION_HPP */
