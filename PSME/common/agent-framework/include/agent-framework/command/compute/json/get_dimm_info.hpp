 ...
 *
 *
 * @file command/compute/json/get_dimm_info.hpp
 *
 * @brief JSON command get dimm information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_DIMM_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_DIMM_INFO_HPP
...
class GetDimmInfo : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = compute::GetDimmInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = compute::GetDimmInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_DIMM_INFO_HPP */
