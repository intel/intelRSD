 ...
 *
 *
 * @file command/compute/set_component_attributes.hpp
 * @brief Definition of generic SetComponentAttributes command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_SET_COMPONENT_ATTRIBUTES_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_SET_COMPONENT_ATTRIBUTES_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMPUTE_SET_COMPONENT_ATTRIBUTES_HPP */
