 ...
 *
 *
 * @file command/chassis/get_manager_collection.hpp
 * @brief Generic chassis GetManagerCollection command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_GET_MANAGER_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_GET_MANAGER_COLLECTION_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_CHASSIS_GET_MANAGER_COLLECTION_HPP */
