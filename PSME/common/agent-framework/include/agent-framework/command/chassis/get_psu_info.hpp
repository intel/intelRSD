...
#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_GET_PSU_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_GET_PSU_INFO_HPP
...
/* Forward declaration */
namespace json { class GetPsuInfo; }

/*! Generic chassis command GetPsuInfo */
class GetPsuInfo : public Command {
public:
    class Request;
    class Response;
    ...
    /*! Tag string for identify GetPsuInfo command */
    static constexpr const char TAG[] = "getPsuInfo";
...
public:
    ...
    public:
         ...
         * @param[in] psu PSU
         * */
        void set_psu(const model::Psu& psu) {
            m_psu = psu;
        }
...
#endif	/* AGENT_FRAMEWORK_COMMAND_CHASSIS_GET_PSU_INFO_HPP */
