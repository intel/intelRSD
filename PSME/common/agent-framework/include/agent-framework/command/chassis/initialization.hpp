 ...
 *
 *
 * @file command/chassis/initialization.hpp
 * @brief Initialization command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_INITIALIZATION_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_INITIALIZATION_HPP
