 ...
 *
 *
 * @file command/chassis/json/get_manager_info.hpp
 *
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = chassis::GetManagerInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = chassis::GetManagerInfo::TAG;
