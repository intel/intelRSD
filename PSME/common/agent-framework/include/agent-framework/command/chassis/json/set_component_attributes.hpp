 ...
 *
 * @file command/chassis/json/set_component_attributes.hpp
 * @brief Declaration of JSON SetComonentsAttributes command interface.
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_SET_COMPONENT_ATTRIBUTES_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_SET_COMPONENT_ATTRIBUTES_HPP
...
public:
    ...
    static constexpr const char* AGENT = chassis::SetComponentAttributes::AGENT;
    /*! @brief Command name tag string */
    static constexpr const char* TAG = chassis::SetComponentAttributes::TAG;
...
#endif /*! AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_SET_COMPONENT_ATTRIBUTES_HPP */
