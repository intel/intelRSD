...
#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_COLLECTION_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = chassis::GetCollection::AGENT;
    /*! Command name tag */
    static constexpr const char* TAG = chassis::GetCollection::TAG;
...
#endif /*! AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_COLLECTION_HPP */
