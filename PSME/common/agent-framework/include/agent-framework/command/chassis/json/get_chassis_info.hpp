 ...
 *
 *
 * @file command/chassis/json/get_chassis_info.hpp
 *
 * @brief JSON command get chassis information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_CHASSIS_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_CHASSIS_INFO_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = chassis::GetChassisInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = chassis::GetChassisInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_CHASSIS_INFO_HPP */
