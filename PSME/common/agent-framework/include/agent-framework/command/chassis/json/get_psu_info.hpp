 ...
 *
 *
 * @file command/chassis/json/get_psu_info.hpp
 *
 * @brief JSON command get component info interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_PSU_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_PSU_INFO_HPP
...
class GetPsuInfo : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = chassis::GetPsuInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = chassis::GetPsuInfo::TAG;
...
#endif	/* AGENT_FRAMEWORK_COMMAND_CHASSIS_JSON_GET_PSU_INFOHPP */
