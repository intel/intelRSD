 ...
 *
 *
 * @file command/network/get_remote_ethernet_switch_info.hpp
 * @brief Generic network GetRemoteEthernetSwitchInfo command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_GET_REMOTE_ETHERNET_SWITCH_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_GET_REMOTE_ETHERNET_SWITCH_INFO_HPP
...
/*! @brief Generic network command GetRemoteEthernetSwitchInfoInfo */
class GetRemoteEthernetSwitchInfo : public Command {
public:
    class Request;
    class Response;
    ...
    static constexpr const char TAG[] = "getRemoteEthernetSwitchInfo";
...
public:
    ...
    private:
        friend class json::GetRemoteEthernetSwitchInfo;
        std::string m_switch{};
    public:
        /*!
    ...
    private:
        friend class json::GetRemoteEthernetSwitchInfo;
        agent_framework::model::RemoteSwitch m_switch{};
    public:
        /*!
         * @brief Set Switch module
         * @param switch_module Switch module reference
         */
        void set_switch(const
            agent_framework::model::RemoteSwitch& switch_module) {
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_GET_REMOTE_ETHERNET_SWITCH_INFO_HPP */
