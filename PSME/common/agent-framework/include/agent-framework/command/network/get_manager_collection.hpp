 ...
 *
 *
 * @file command/network/get_manager_collection.hpp
 * @brief Generic network GetManagerCollection command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_GET_MANAGER_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_GET_MANAGER_COLLECTION_HPP
...
/*! Generic network command GetCollection */
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_GET_MANAGER_COLLECTION_HPP */
