 ...
 *
 *
 * @file command/network/get_collection.hpp
 * @brief Generic network GetCollection command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_GET_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_GET_COLLECTION_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_GET_COLLECTION_HPP */
