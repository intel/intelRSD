 ...
 *
 *
 * @file command/network/json/delete_switch_port.hpp
 *
 * @brief JSON command DeleteEthernetSwitchPort interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_DELETE_ETHERNET_SWITCH_PORT_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_DELETE_ETHERNET_SWITCH_PORT_HPP
...
class DeleteEthernetSwitchPort : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT =
        network::DeleteEthernetSwitchPort::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = network::DeleteEthernetSwitchPort::TAG;
...
#endif
/* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_DELETE_ETHERNET_SWITCH_PORT_HPP */
