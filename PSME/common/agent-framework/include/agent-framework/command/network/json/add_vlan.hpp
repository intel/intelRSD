 ...
 *
 *
 * @file command/network/json/add_vlan.hpp
 *
 * @brief JSON command AddVlan interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_ADD_VLAN_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_ADD_VLAN_HPP

#include "agent-framework/command/command_json.hpp"
#include "agent-framework/command/network/add_vlan.hpp"
...
class AddVlan : public CommandJson {
public:

    /*! @brief Agent name tag */
    static constexpr const char* AGENT = network::AddVlan::AGENT;

    /*! @brief Command name tag */
    static constexpr const char* TAG = network::AddVlan::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_ADD_VLAN_HPP */
