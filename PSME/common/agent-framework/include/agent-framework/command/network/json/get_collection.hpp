...
#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_COLLECTION_HPP
...
public:
  /*! Agent tag string */
  static constexpr const char* AGENT = network::GetCollection::AGENT;

  /*! Command name tag string */
  static constexpr const char* TAG = network::GetCollection::TAG;
...
#endif /*! AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_COLLECTION_HPP */
