...
#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_MANAGER_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_MANAGER_COLLECTION_HPP
...
class GetManagerCollection : public agent_framework::command::CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = network::GetManagerCollection::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG   = network::GetManagerCollection::TAG;
...
#endif /*! AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_MANAGER_COLLECTION_HPP */
