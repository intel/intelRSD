 ...
 *
 *
 * @file command/network/json/get_network_info.hpp
 *
 * @brief JSON command get network information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_CHASSIS_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_CHASSIS_INFO_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = network::GetChassisInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = network::GetChassisInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_CHASSIS_INFO_HPP */
