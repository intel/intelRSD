 ...
 *
 *
 * @file command/network/json/get_ethernet_switch_info.hpp
 *
 * @brief JSON command get switch information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_ETHERNET_SWITCH_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_ETHERNET_SWITCH_INFO_HPP
...
class GetEthernetSwitchInfo : public CommandJson {
public:
    /*! @brief Agent name tag */
    static constexpr const char* AGENT = network::GetEthernetSwitchInfo::AGENT;

    /*! @brief Command name tag */
    static constexpr const char* TAG = network::GetEthernetSwitchInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_ETHERNET_SWITCH_INFO_HPP */
