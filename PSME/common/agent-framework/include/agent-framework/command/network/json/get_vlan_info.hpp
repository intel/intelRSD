 ...
 *
 *
 * @file command/network/json/get_vlan_info.hpp
 * @brief JSON command get port vlan information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_VLAN_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_VLAN_INFO_HPP
...
class GetVlanInfo : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = network::GetVlanInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = network::GetVlanInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_VLAN_INFO_HPP */
