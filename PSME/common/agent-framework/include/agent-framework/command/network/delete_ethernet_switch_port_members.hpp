 ...
 *
 *
 * @file command/network/delete_ethernet_switch_port_members.hpp
 * @brief Generic network DeleteEthernetSwitchPortMembers command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_DELETE_ETHERNET_SWITCH_PORT_MEMBERS_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_DELETE_ETHERNET_SWITCH_PORT_MEMBERS_HPP
...
/* Forward declaration */
namespace json { class DeleteEthernetSwitchPortMembers; }

using MemberArray = std::vector<std::string>;

/*! Generic network command DeleteEthernetSwitchPortMembers */
class DeleteEthernetSwitchPortMembers : public Command {
public:
    class Request;
    class Response;
    ...
    static constexpr const char TAG[] = "deleteEthernetSwitchPortMembers";
    ...
    /*! Command destructor */
    virtual ~DeleteEthernetSwitchPortMembers();
protected:
    /*!
...
public:
    ...
    private:
        friend class json::DeleteEthernetSwitchPortMembers;
...
#endif
/* AGENT_FRAMEWORK_COMMAND_NETWORK_DELETE_ETHERNET_SWITCH_PORT_MEMBERS_HPP */
