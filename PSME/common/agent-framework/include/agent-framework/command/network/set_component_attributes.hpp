 ...
 *
 *
 * @file command/network/set_component_attributes.hpp
 * @brief Definition of generic SetComponentAttributes command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_SET_COMPONENT_ATTRIBUTES_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_SET_COMPONENT_ATTRIBUTES_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_SET_COMPONENT_ATTRIBUTES_HPP */
