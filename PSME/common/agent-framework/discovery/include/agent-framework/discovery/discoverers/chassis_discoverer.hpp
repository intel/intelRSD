...
public:
     ...
     * */
    virtual agent_framework::model::Chassis discover(const Uuid& parent_uuid);


    /*!
     * @brief Perform additional discovery from database.
     * @param chassis Chassis object to be updated.
     */
    virtual void discover_database(agent_framework::model::Chassis& chassis);
