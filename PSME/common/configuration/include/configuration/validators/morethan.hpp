...
/*! Json more than validator class */
class MoreThanValidator final : public Validator<json::Value> {
public:
    /*!
     * @brief Construct MoreThanValidator for given value
     * @param value bottom constaint
     */
    explicit MoreThanValidator(const double value) : m_min_value{value} {}
    ~MoreThanValidator() = default;
    ...
    /*!
     * @brief Get moreThan error message
