...
from include.psme_xml_structure.model.ipv4_address import Ipv4Address

class Ipv4AddressManager(Manager):
    @classmethod
    def get_data(cls, data, context=None):
        data = cls.prepare_data(data)
        ipv4_address = Ipv4Address()

        ipv4_address = cls.set_fields(ipv4_address, data, context=context)
    ...
    @staticmethod
    def my_context():
        return ManagersTypes.IPV4_ADDRESS_MANAGER
