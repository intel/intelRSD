...
#ifndef AGENT_STUBS_NETWORK_STATUS_STATUS_MANAGER_HPP
#define AGENT_STUBS_NETWORK_STATUS_STATUS_MANAGER_HPP
...
#endif /* AGENT_STUBS_NETWORK_STATUS_STATUS_MANAGER_HPP */
