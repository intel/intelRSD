 ...
 *
 * @file main.cpp
 * @brief Stubbed Chassis main class
 * */
...
int main(int argc, const char* argv[]) {
    ...
    log_info(GET_LOGGER("agent"), "Running Chassis Stub...\n");
    ...
    ::agent::chassis::generate_data();

    for (const auto& elem : ::agent_framework::module::ChassisManager::get_instance()->
