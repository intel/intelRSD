...
#ifndef AGENT_STUBS_CHASSIS_STATUS_MODULE_SOFTWARE_STATUS_HPP
#define AGENT_STUBS_CHASSIS_STATUS_MODULE_SOFTWARE_STATUS_HPP
...
#endif /* AGENT_STUBS_CHASSIS_STATUS_MODULE_SOFTWARE_STATUS_HPP */
