...
#ifndef AGENT_STUBS_COMPUTE_STATUS_STATUS_MANAGER_HPP
#define AGENT_STUBS_COMPUTE_STATUS_STATUS_MANAGER_HPP
...
#endif /* AGENT_STUBS_COMPUTE_STATUS_STATUS_MANAGER_HPP */
