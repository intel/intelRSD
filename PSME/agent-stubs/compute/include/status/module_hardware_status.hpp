...
#ifndef AGENT_STUBS_COMPUTE_STATUS_MODULE_HARDWARE_STATUS_HPP
#define AGENT_STUBS_COMPUTE_STATUS_MODULE_HARDWARE_STATUS_HPP
...
#endif /* AGENT_STUBS_COMPUTE_STATUS_MODULE_HARDWARE_STATUS_HPP */
