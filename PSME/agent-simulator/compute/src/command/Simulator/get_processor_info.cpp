...
namespace agent {
/*! Simulator GetProcessorInfo implementation */
...
public:
    ...
    void execute(const Request& request, Response& response) {
        ...
        response.set_processor(ComputeComponents::get_instance()->
                                    get_processor_manager().get_entry(
                                            request.get_processor()));
    }
...
static Command::Register<agent::GetProcessorInfo> g("Simulator");
