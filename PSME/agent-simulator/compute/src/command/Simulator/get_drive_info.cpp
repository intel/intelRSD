...
namespace agent {
/*! Simulator GetDriveInfo implementation */
...
public:
    ...
    void execute(const Request& request, Response& response) {
        ...
        response.set_drive(ComputeComponents::get_instance()->
                                    get_drive_manager().get_entry(
                                            request.get_drive()));
    }
    ~GetDriveInfo();
...
static Command::Register<agent::GetDriveInfo> g("Simulator");
