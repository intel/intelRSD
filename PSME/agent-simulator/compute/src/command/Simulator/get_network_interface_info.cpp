...
namespace agent {
/*! Simulator GetNetworkInterfaceInfo implementation */
...
public:
    ...
    void execute(const Request& request, Response& response) {
        ...
        response.set_interface(ComputeComponents::get_instance()->
                                    get_network_interface_manager().get_entry(
...
static Command::Register<agent::GetNetworkInterfaceInfo> g("Simulator");
