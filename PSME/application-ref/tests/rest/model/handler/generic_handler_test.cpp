...
#include "../src/rest-ref/model/handlers/handler_manager.cpp"
...
public:
    ...
    void reset_id_policy() {
        ...
        static_cast<psme::rest::model::handler::SystemHandler *>(psme::rest::model::handler::HandlerManager::get_instance()->get_handler(
                enums::Component::System))->m_id_policy.reset();
        static_cast<psme::rest::model::handler::ProcessorHandler *>(psme::rest::model::handler::HandlerManager::get_instance()->get_handler(
...
TEST_F(HandlerTest, AddEverything) {
    ...
    ASSERT_EQ("system_1_uuid", psme::rest::model::Find<agent_framework::model::System>("1").get_one()->get_uuid());
    ASSERT_EQ("system_2_uuid", psme::rest::model::Find<agent_framework::model::System>("2").get_one()->get_uuid());
    ASSERT_EQ("system_3_uuid", psme::rest::model::Find<agent_framework::model::System>("3").get_one()->get_uuid());
    ASSERT_EQ("processor_1_uuid", psme::rest::model::Find<agent_framework::model::Processor>("1").via<agent_framework::model::System>("2").get_one()->get_uuid());
    ASSERT_EQ("processor_2_uuid", psme::rest::model::Find<agent_framework::model::Processor>("2").via<agent_framework::model::System>("2").get_one()->get_uuid());
    ASSERT_EQ("processor_1_system_3_uuid", psme::rest::model::Find<agent_framework::model::Processor>("1").via<agent_framework::model::System>("3").get_one()->get_uuid());
}
...
TEST_F(HandlerTest, RemoveLeaf) {
    ...
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::Processor>("1").via<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_EQ("processor_2_uuid", psme::rest::model::Find<agent_framework::model::Processor>("2").via<agent_framework::model::System>("2").get_one()->get_uuid());
...
TEST_F(HandlerTest, RemoveInnerNode) {
    ...
    ASSERT_EQ("system_1_uuid", psme::rest::model::Find<agent_framework::model::System>("1").get_one()->get_uuid());
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::Processor>("1").via<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::Processor>("2").via<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
...
TEST_F(HandlerTest, TestProperIdsAfterAgentReconnection) {
    ...
    psme::rest::model::handler::HandlerManager::get_instance()->remove_agent_data(agent_gami_id);
    ...
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::System>("1").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::System>("3").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::Processor>("1").via<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::Processor>("2").via<agent_framework::model::System>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
    ...
    ASSERT_EQ(3, get_manager<System>().get_entry_count());
    ASSERT_EQ(3, get_manager<Processor>().get_entry_count());
    ASSERT_EQ("system_1_uuid", psme::rest::model::Find<agent_framework::model::System>("4").get_one()->get_uuid());
    ASSERT_EQ("system_2_uuid", psme::rest::model::Find<agent_framework::model::System>("5").get_one()->get_uuid());
    ASSERT_EQ("system_3_uuid", psme::rest::model::Find<agent_framework::model::System>("6").get_one()->get_uuid());
    ASSERT_EQ("processor_1_uuid", psme::rest::model::Find<agent_framework::model::Processor>("1").via<agent_framework::model::System>("5").get_one()->get_uuid());
    ASSERT_EQ("processor_2_uuid", psme::rest::model::Find<agent_framework::model::Processor>("2").via<agent_framework::model::System>("5").get_one()->get_uuid());
}
...
TEST_F(HandlerTest, LoadLeaf) {
    ...
    auto agent = psme::core::agent::AgentManager::get_instance().get_agent("anything");
    auto handler = psme::rest::model::handler::HandlerManager::get_instance()->get_handler(agent_framework::model::enums::Component::Processor);
    agent-> m_responses = {
        Processor1OnSystem3Modified
    };
    auto rest_id = handler->load(agent, "system_3_uuid", "processor_1_system_3_uuid");
    EXPECT_EQ(1, rest_id); // should retain rest id

    auto expectedReq = std::vector<std::string> {"processor_1_system_3_uuid"};
    CHECK_REQUESTS;

    auto proc = psme::rest::model::Find<agent_framework::model::Processor>("1").
    ...
    EXPECT_EQ(666 /* new value from updated processor */, proc->get_max_speed_mhz());

    // no event expected after load
    auto expectedEvents = std::vector<std::pair<EventType, std::string>> {{EventType::ResourceUpdated, "/redfish/v1/Systems/3/Processors/1"}};
    CHECK_EVENTS;
}
...
TEST_F(HandlerTest, LoadInternalNonRecursively) {
    ...
    auto agent = psme::core::agent::AgentManager::get_instance().get_agent("anything");
    auto handler = psme::rest::model::handler::HandlerManager::get_instance()
            ->get_handler(agent_framework::model::enums::Component::System);
    agent-> m_responses = {
        System2Modified
    };
    auto rest_id = handler->load(agent, "manager_1_uuid", "system_2_uuid");
    EXPECT_EQ(2, rest_id); // should retain rest id

    auto expectedReq = std::vector<std::string> {"system_2_uuid"};
    CHECK_REQUESTS;

    auto system = psme::rest::model::Find<agent_framework::model::System>("2").
...
TEST_F(HandlerTest, LoadInternalRecursively) {
    ...
    auto rest_id = handler->load(agent, "manager_1_uuid", "system_2_uuid", true /* recursively */);
    EXPECT_EQ(2, rest_id); // should retain rest id
    ...
    auto processor2 = psme::rest::model::Find<agent_framework::model::Processor>("2").
...
TEST_F(HandlerTest, TestUpdateEvent) {
    BuildTreeWithAddEvent();
    psme::core::agent::AgentManager::get_instance().get_agent("anything")->clear();
    SubscriptionManager::get_instance()->clear();
...
TEST_F(HandlerTest, PollingNoUpdate) {
    ...
    handler->poll(agent, "manager_1_uuid", "system_2_uuid");
...
TEST_F(HandlerTest, PollingDetectsInnerNodeRemoved) {
    ...
    handler->poll(agent, "", "manager_1_uuid");
...
TEST_F(HandlerTest, PollingDetectsSubtreeAdded) {
    ...
    handler->poll(agent, "", "manager_2_uuid");
...
TEST_F(HandlerTest, NothingAddedIfJsonRpcExeptionDuringAddEventHandling) {
    ...
    ASSERT_THROW(psme::rest::model::Find<agent_framework::model::System>("3").via<agent_framework::model::Manager>("2").get_one()->get_uuid(), agent_framework::exceptions::NotFound);
}
...
TEST_F(HandlerTest, DifferentCollectionNamesForSameResourceType) {
    ...
    ASSERT_EQ("system_5_uuid", psme::rest::model::Find<agent_framework::model::System>("1").via<agent_framework::model::Manager>("1").get_one()->get_uuid());

    ASSERT_EQ("system_6_uuid", psme::rest::model::Find<agent_framework::model::System>("2").via<agent_framework::model::Manager>("1").get_one()->get_uuid());

    ASSERT_EQ("processor_1_uuid", psme::rest::model::Find
        <agent_framework::model::Processor>("1").via
        <agent_framework::model::System>("1").get_one()->get_uuid());

    ASSERT_EQ("processor_2_uuid", psme::rest::model::Find
        <agent_framework::model::Processor>("2").via
        <agent_framework::model::System>("1").get_one()->get_uuid());

    ASSERT_EQ("processor_3_uuid", psme::rest::model::Find
        <agent_framework::model::Processor>("1").via
        <agent_framework::model::System>("2").get_one()->get_uuid());

    ASSERT_EQ("processor_4_uuid", psme::rest::model::Find
        <agent_framework::model::Processor>("2").via
        <agent_framework::model::System>("2").get_one()->get_uuid());
...
TEST_F(HandlerTest, LoadCollectionNonRecursive) {
    ...
    handler->load_collection(agent, "manager_3_uuid", enums::CollectionType::Systems, false);
    auto expectedReq = std::vector<std::string> {
        "manager_3_uuid",
        "manager_3_uuid",
        "system_5_uuid",
...
TEST_F(HandlerTest, LoadCollectionRecursive) {
    ...
    auto handler = psme::rest::model::handler::HandlerManager::get_instance()
            ->get_handler(agent_framework::model::enums::Component::Manager);
    handler->load_collection(agent, "manager_3_uuid", enums::CollectionType::Systems, true);
