...
void clean_model_data() {
    ComputeManager::get_instance()->
            get_system_manager().clear_entries();
    ComputeManager::get_instance()->
        get_processor_manager().clear_entries();
    ComputeManager::get_instance()->
        get_module_manager().clear_entries();
    ComputeManager::get_instance()->
        get_chassis_manager().clear_entries();
    ComputeManager::get_instance()->
        get_drive_manager().clear_entries();
    ComputeManager::get_instance()->
        get_dimm_manager().clear_entries();
    ComputeManager::get_instance()->
        get_network_interface_manager().clear_entries();
    ComputeManager::get_instance()->
        get_storage_controller_manager().clear_entries();
    ComputeManager::get_instance()->
            get_chassis_manager().clear_entries();
}
...
namespace {
    ...
    Manager make_manager(const std::string& parent, const std::string& uuid) {
        ...
        manager.add_collection(attribute::Collection(enums::CollectionName::Systems, enums::CollectionType::Systems, "slotMask"));
        return manager;
    }
    ...
    System make_system(const std::string& parent, const std::string& uuid) {
        ...
        system.add_collection(attribute::Collection(enums::CollectionName::Processors, enums::CollectionType::Processors, "slotMask"));
        system.add_collection(attribute::Collection(enums::CollectionName::Memories, enums::CollectionType::Dimms, "slotMask"));
        system.add_collection(attribute::Collection(enums::CollectionName::StorageControllers, enums::CollectionType::StorageControllers, "slotMask"));
        system.add_collection(attribute::Collection(enums::CollectionName::NetworkInterfaces, enums::CollectionType::NetworkInterfaces, "slotMask"));
...
void generate_model_data() {
    ComputeManager::get_instance()->
            get_module_manager().add_entry(make_manager("", "1111"));

    ComputeManager::get_instance()->
            get_module_manager().add_entry(make_manager("", "1222"));

    ComputeManager::get_instance()->
            get_module_manager().add_entry(make_manager("", "1333"));


    ComputeManager::get_instance()->
            get_system_manager().add_entry(make_system("1111", "2111"));

    ComputeManager::get_instance()->
            get_system_manager().add_entry(make_system("1111", "2222"));

    ComputeManager::get_instance()->
            get_system_manager().add_entry(make_system("1222", "2333"));


    ComputeManager::get_instance()->
        get_processor_manager().add_entry(::make_processor("2111", "3111"));

    ComputeManager::get_instance()->
        get_processor_manager().add_entry(::make_processor("2111", "3222"));

    ComputeManager::get_instance()->
        get_processor_manager().add_entry(::make_processor("2111", "3333"));
}
