...
#ifndef APP_REST_ENDPOINT_THERMAL_ZONE_HPP
#define APP_REST_ENDPOINT_THERMAL_ZONE_HPP
 ...
 */
class ThermalZone : public Endpoint {
public:
...
#endif // APP_REST_ENDPOINT_THERMAL_ZONE_HPP
