...
#ifndef APP_REST_ENDPOINT_PATH_BUILDER_HPP
#define APP_REST_ENDPOINT_PATH_BUILDER_HPP
...
public:
    ...
    PathBuilder& append(T&& segment) {
        m_str << ::app::rest::constants::PathParam::PATH_SEP
     ...
     * to build path.
     *
     * @param name Variable name part of segment appended to build path.
     * @param regex Regex part of segment appended to build path.
     * @return PathBuilder reference for chaining.
     */
