...
#ifndef PSME_REST_SERVER_CONNECTOR_CONNECTOR_HPP
#define PSME_REST_SERVER_CONNECTOR_CONNECTOR_HPP
...
/*!
 * Default Connector callback for request processing if none is provided
 * via Connector::set_callback method.
...
public:
     ...
     * @brief Constructor.
     *
     * @param options ConnectorOptions used for Connector initialization.
     */
...
#endif /* PSME_REST_SERVER_CONNECTOR_CONNECTOR_HPP */
