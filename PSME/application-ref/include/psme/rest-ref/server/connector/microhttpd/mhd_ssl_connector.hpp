...
#ifndef PSME_REST_SERVER_CONNECTOR_MHD_SSL_CONNECTOR_HPP
#define PSME_REST_SERVER_CONNECTOR_MHD_SSL_CONNECTOR_HPP
...
#endif /* PSME_REST_SERVER_CONNECTOR_MHD_SSL_CONNECTOR_HPP */
