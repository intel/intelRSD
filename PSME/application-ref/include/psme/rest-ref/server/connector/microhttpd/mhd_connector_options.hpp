...
#ifndef PSME_REST_SERVER_CONNECTOR_MHD_CONNECTOR_OPTIONS_HPP
#define PSME_REST_SERVER_CONNECTOR_MHD_CONNECTOR_OPTIONS_HPP
...
#endif /* PSME_REST_SERVER_CONNECTOR_MHD_CONNECTOR_OPTIONS_HPP */
