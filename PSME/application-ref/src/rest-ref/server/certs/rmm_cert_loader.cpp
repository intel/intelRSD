...
#include "psme/rest-ref/server/certs/rmm_cert_loader.hpp"
#include "psme/core/agent/agent_manager.hpp"
#include "agent-framework/module-ref/requests/chassis/get_authorization_certificate.hpp"
...
namespace {
    std::string get_cert_from_agent(psme::core::agent::JsonAgent& agent) {
        ...
        auto auth_cert = agent.execute<GetAuthorizationCertificate>(request);
