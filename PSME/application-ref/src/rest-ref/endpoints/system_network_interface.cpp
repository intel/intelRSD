...
#include "psme/rest-ref/endpoints/system_network_interface.hpp"
...
json::Value make_prototype() {
    ...
    r[constants::NetworkInterface::MAC_ADDRESS] = json::Value::Type::NIL;
...
endpoint::SystemNetworkInterface::SystemNetworkInterface(const std::string& path) : Endpoint(path) {}
...
void endpoint::SystemNetworkInterface::get(const server::Request& req, server::Response& res) {
    ...
    endpoint::utils::status_to_json(ni, r);

    r[constants::NetworkInterface::PERMANENT_MAC_ADDRESS] = ni.get_factory_mac_address();
    r[constants::NetworkInterface::MAC_ADDRESS] = ni.get_mac_address();
