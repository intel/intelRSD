...
#include "psme/rest-ref/endpoints/ethernet_switch_collection.hpp"
...
endpoint::EthernetSwitchCollection::EthernetSwitchCollection(const std::string& path) : Endpoint(path) {}
...
void endpoint::EthernetSwitchCollection::get(const server::Request& req, server::Response& res) {
    ...
    auto switch_ids = agent_framework::module::NetworkManager::get_instance()->
