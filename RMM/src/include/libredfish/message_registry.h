...
#ifndef __LIBREDFISH_MESSAGE_REGISTRY_H__
#define __LIBREDFISH_MESSAGE_REGISTRY_H__
...
struct message_registry {
	...
	int8		modified[MAX_MODIFIED_SIZE];
	int8		type[MAX_TYPE_SIZE];
 ...
 */
extern int32 mr_get_args_format(int8 *fmt, int32 max_len, int32 num);
 ...
 * @param  num 				the num of redfish message.
 */
extern int32 mr_get_msg_id_str(int8 *identity, int32 max_len, int32 num);
 ...
 * @param  num 				the num of redfish message.
 */
extern int32 mr_get_msg_str(int8 *msg, int32 num, int8 *args);
 ...
 */
extern int32 mr_get_location_idx(int32 num, int8 *args);
