...
NAVIGATION_PROPERTY_TEMPLATE = """
<div>
    <h3>{{property.name}}</h3>
    <table>
        <tr><td>is collection?</td><td>{{property.is_collection}}</td></tr>
        <tr><td>type:</td><td><a href="#entity_{{property.type}}">{{property.type}}</a></td></tr>
        <tr><td>nullable:</td><td>{{property.nullable}}</td></tr>
        <tr><td>required:</td><td>{{property.required}}</td></tr>
        <tr><td>contains_target:</td><td>{{property.contains_target}}</td></tr>
    </table>
