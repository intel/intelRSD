...
public interface RemoteDetachStrategy<T extends DiscoverableEntity & AttachableAsset & ComposableAsset> {

    void detachOnRemoteFabric(T assetToBeDetached, AttachDetachOperationContext context) throws EntityOperationException;

    void onAfterRemoteDetach(T resource) throws BusinessApiException;
}
