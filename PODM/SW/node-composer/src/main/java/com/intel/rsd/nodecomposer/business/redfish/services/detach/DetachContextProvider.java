...
public interface DetachContextProvider<T extends DiscoverableEntity & AttachableAsset & ComposableAsset> {
    AttachDetachOperationContext createContext(T assetToBeDetached, ComposedNode composedNode);
}
