...
public class PcieLocalStorageAssemblyTaskFactory {
    ...
    @Autowired
    public PcieLocalStorageAssemblyTaskFactory(NodeComposerBeanFactory beanFactory) {
        this.beanFactory = beanFactory;
    }

    public NodeTask createLocalStorageTask(ODataId driveUri) {
        PcieLocalStorageAssemblyTask pcieLocalStorageAssemblyTask = beanFactory.create(PcieLocalStorageAssemblyTask.class);
        pcieLocalStorageAssemblyTask.setDriveUri(driveUri);
