...
public interface DetachRequestValidator<T extends DiscoverableEntity & AttachableAsset & ComposableAsset> {
    void validate(ComposedNode composedNode, T resource) throws BusinessApiException;
}
