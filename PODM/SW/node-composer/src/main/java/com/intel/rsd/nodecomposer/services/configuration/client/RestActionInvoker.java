...
public class RestActionInvoker {
    ...
    @Autowired
    public RestActionInvoker(@Value("${discovery-service.basicAuthToken:#{null}}") String basicAuthToken, WebClientBuilder webClientBuilder) {
        this.basicAuthToken = basicAuthToken;
        this.webClientBuilder = webClientBuilder;
    }

    public URI post(URI baseUri, URI requestUri, Object request) {
        try (WebClient webClient = createDiscoveryServiceWebClient(baseUri)) {
    ...
    public WebClient createDiscoveryServiceWebClient(URI baseUri) {
