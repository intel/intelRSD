...
public class ResourceFinderException extends CompositionException {
    private static final long serialVersionUID = -8320590605060608989L;

    public ResourceFinderException(Violations violations) {
        super(violations);
    }
}
