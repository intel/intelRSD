...
public class StorageServiceDisassemblyTask extends NodeTask implements Serializable {
    ...
    @Autowired
    private transient StorageServiceAssetsSelector storageServiceAssetsSelector;
    ...
    private void decompose() {
        ...
        Collection<DiscoverableEntity> assetsInOrder = storageServiceAssetsSelector.selectRelatedAssets(composedNode);
