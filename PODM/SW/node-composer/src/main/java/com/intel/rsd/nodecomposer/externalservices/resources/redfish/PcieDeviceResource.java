...
public class PcieDeviceResource extends ExternalServiceResourceImpl {
    @Getter
    @JsonProperty("Status")
    ...
    public Iterable<ResourceSupplier> getPcieDeviceFunctions() throws WebClientRequestException {
        return toSuppliers(links.pcieDeviceFunctions);
    }
    ...
    public class Links {
        ...
        private List<ODataId> pcieDeviceFunctions;
