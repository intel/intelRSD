...
@ActiveProfiles({"truststore-based-verification", "https-only-service-registrar", "ssdp"})
public class RsdInitializationWithSsdp extends AbstractTestNGSpringContextTests {
