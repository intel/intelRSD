...
public class ClassFilterTest {
    // given
    private final List<Class<?>> list = newArrayList(FirstComponent.class, SecondComponent.class,
    ...
    public void shouldNotFilterWithAlwaysTruePredicate() {
        // when
        Iterable<Class<?>> result = ClassFilter.only().satisfying(klass -> true).from(list);
