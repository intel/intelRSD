...
// TODO enable tests after enabling annotation processing during Gradle's compileTestJava task
...
public class ClassIndexTest {
    ...
    public void shouldReturnNamesOfClassesInsidePackage() {
        // when
        Iterable<String> packageSubclasses = ClassIndex.getPackageClassesNames(ClassIndexTest.class.getPackage().getName());
