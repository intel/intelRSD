...
public final class ClassFilter {
    ...
    public interface UnionBuilder extends FilterBuilder {
         ...
         */
        UnionBuilder enclosedIn(Class<?> enclosing);

        /**
         * Returns classes nested directly in given class.
         */
        UnionBuilder enclosedDirectlyIn(Class<?> enclosing);
         ...
         */
        UnionBuilder annotatedWith(Class<? extends Annotation> annotation);
         ...
         * (see: <a href="http://thecodersbreakfast.net/index.php?post/2011/09/26/Inner-classes-and-the-myth-of-the-default-constructor">
         * Inner classes and the myth of the default constructor</a>)
         * </p>
         */
    ...
    private static class Builder extends CommonFilterBuilder implements UnionBuilder {
        ...
        public Builder topLevel() {
            return satisfying(klass -> klass.getEnclosingClass() == null);
        }

        @Override
        public UnionBuilder topLevelOrStaticNested() {
            return satisfying(klass -> klass.getEnclosingClass() == null || (klass.getModifiers() & Modifier.STATIC) != 0);
        }

        @Override
        public Builder enclosedIn(final Class<?> enclosing) {
            return satisfying(klass -> {
                while (true) {
        ...
        public Builder annotatedWith(final Class<? extends Annotation> annotation) {
            ...
            return satisfying(klass -> klass.isAnnotationPresent(annotation));
        }

        @Override
        public UnionBuilder withModifiers(final int modifiers) {
            return satisfying(klass -> (klass.getModifiers() & modifiers) != 0);
        }
        ...
        public UnionBuilder interfaces() {
            return satisfying(klass -> klass.isInterface());
        }
