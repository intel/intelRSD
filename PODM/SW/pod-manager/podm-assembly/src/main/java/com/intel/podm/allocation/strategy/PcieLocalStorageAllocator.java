...
import com.intel.podm.assembly.tasks.PcieLocalStorageAssemblyTaskFactory;
...
public class PcieLocalStorageAllocator {
    ...
    public List<NodeAssemblyTask> prepareNodeAssemblyTasks(Set<PcieLocalStorage> selectedPcieLocalStorages, Set<LocalStorage> availableStorage) {
        ...
        List<NodeAssemblyTask> assemblyTask = nodeDisassembler.preparePcieDriveDetachTasks(availableButNotSelected).stream().collect(toList());
