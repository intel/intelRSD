...
public class NewRemoteDriveTaskFactory {
    ...
    public NewRemoteDriveAssemblyTask create(Id logicalDriveId, URI sourceUri, RequestedRemoteDrive drive) {
        ...
        ExternalService service = lvg.getService();
        if (service == null) {
        ...
        newRemoteDriveAssemblyTask.setStorageServiceSourceUri(lvg.getStorageService().getSourceUri());
        newRemoteDriveAssemblyTask.setLvgSourceUri(lvg.getSourceUri());
        newRemoteDriveAssemblyTask.setMasterDriveSourceUri(sourceUri);
