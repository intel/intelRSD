...
@Dependent
public class MemoryChunkMapper extends DomainObjectMapper<MemoryChunkResource, MemoryChunk> {
    public MemoryChunkMapper() {
        super(MemoryChunkResource.class, MemoryChunk.class);
    }
}
