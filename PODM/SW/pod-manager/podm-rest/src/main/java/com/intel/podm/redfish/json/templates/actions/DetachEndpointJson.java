...
public class DetachEndpointJson implements DetachEndpointRequest {
    private Context pcieDriveContext;

    @JsonProperty("Resource")
    public void setPcieDriveContext(ODataId pcieDrive) {
        if (pcieDrive == null) {
            return;
        }

        pcieDriveContext = getContextFromUri(pcieDrive.toUri(), DRIVE);
    }

    @Override
    public Context getPcieDriveContext() {
        return pcieDriveContext;
    }
}
