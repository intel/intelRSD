...
public class AdapterResource extends BaseResource {
    ...
    @GET
    @Override
    public AdapterDto get() {
        return getOrThrow(() -> adapterService.getAdapter(getCurrentContext()));
    }

    @Path(DEVICES_RESOURCE_NAME)
    public DevicesCollectionResource getDevices() {
