...
public class DriveMetricsResource extends BaseResource {
    @Inject
    private ReaderService<DriveMetricsDto> readerService;

    @Override
    public Object get() {
        Context context = getCurrentContext();
        DriveMetricsDto dto = getOrThrow(() -> readerService.getResource(context));
        return new RedfishResourceAmazingWrapper(singletonContextOf(context, DRIVE_METRICS_RESOURCE_NAME), dto);
    }
