...
public class PcieDeviceFunctionCollectionResource extends BaseResource {
    @Inject
    ...
    @Path(PCIE_DEVICE_FUNCTION_ID)
    public PcieDeviceFunctionResource getPcieDeviceFunction() {
