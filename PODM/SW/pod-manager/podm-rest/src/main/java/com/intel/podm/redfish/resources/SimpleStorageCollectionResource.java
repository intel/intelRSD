...
import static com.intel.podm.redfish.resources.SimpleStorageResource.SIMPLE_STORAGE_ID_PARAM;
...
public class SimpleStorageCollectionResource extends BaseResource {
    ...
    @Override
    public Object get() {
        return getOrThrow(() -> simpleStorageService.getSimpleStorageCollection(getCurrentContext()));
    }

    @Path(SIMPLE_STORAGE_ID_PARAM)
