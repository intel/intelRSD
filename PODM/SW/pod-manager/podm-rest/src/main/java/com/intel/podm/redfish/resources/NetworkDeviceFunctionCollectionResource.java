...
public class NetworkDeviceFunctionCollectionResource extends BaseResource {
    @Inject
    ...
    @Path(NETWORK_DEVICE_FUNCTION_ID)
    public NetworkDeviceFunctionResource getNetworkDeviceFunction() {
        return getResource(NetworkDeviceFunctionResource.class);
    }
}
