...
public class MetricDefinitionCollectionResource extends BaseResource {
    @Inject
    private ReaderService<MetricDefinitionDto> readerService;
    ...
    @GET
    @Path("{id}")
    public RedfishResourceAmazingWrapper getTelemetryMetricDefinition(@PathParam("id") String id) {
    ...
    private Context contextFromTelemetryServiceId(String id) {
        // TODO: RSASW-8103
        return contextOf(id(""), TELEMETRY_SERVICE).child(id(id), METRIC_DEFINITION);
    }
