...
public class EthernetSwitchPortMetricsResource extends BaseResource {
    @Inject
    private ReaderService<EthernetSwitchPortMetricsDto> readerService;

    @GET
    @Override
    public RedfishResourceAmazingWrapper get() {
        Context context = getCurrentContext();
        EthernetSwitchPortMetricsDto dto = getOrThrow(() -> readerService.getResource(context));
        return new RedfishResourceAmazingWrapper(singletonContextOf(context, ETHERNET_SWITCH_PORT_METRICS_RESOURCE_NAME), dto);
    }
