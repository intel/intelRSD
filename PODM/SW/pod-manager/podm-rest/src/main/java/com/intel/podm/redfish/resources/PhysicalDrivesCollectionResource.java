...
import static com.intel.podm.rest.resources.PathParamConstants.PHYSICAL_DRIVE_ID;
...
public class PhysicalDrivesCollectionResource extends BaseResource {
    ...
    public CollectionDto get() {
        return getOrThrow(() -> service.getPhysicalDrivesCollection(getCurrentContext()));
    }
