...
public class AttachEndpointJson implements AttachEndpointRequest {
    ...
    public void setDriveContext(ODataId pcieDrive) {
        if (pcieDrive == null) {
            return;
        }

        driveContext = getContextFromUri(pcieDrive.toUri(), DRIVE);
    }
