...
public class ComputerSystemUpdateRequest {
    ...
    private Set<TrustedModuleUpdateDefinition> convertToTrustedModuleUpdateDefinition(Set<TrustedModule> trustedModules) {
    ...
    private class TrustedModuleUpdateDefinition {
        ...
        TrustedModuleUpdateDefinition(TrustedModule trustedModule) {
