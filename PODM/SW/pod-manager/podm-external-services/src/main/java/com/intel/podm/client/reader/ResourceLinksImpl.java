...
public class ResourceLinksImpl implements ResourceLinks {
    ...
    public ResourceLinksImpl(ExternalServiceResource resource) {
    ...
    private Object invoke(Method method) throws ExternalServiceApiReaderException {
        Object result;
        try {
            ...
            if (e.getTargetException() instanceof ExternalServiceApiReaderException) {
                throw (ExternalServiceApiReaderException) e.getTargetException();
            }
