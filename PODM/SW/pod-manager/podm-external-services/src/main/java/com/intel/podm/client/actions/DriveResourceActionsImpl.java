...
import com.intel.podm.client.actions.requests.DriveUpdateRequest;
...
public class DriveResourceActionsImpl implements DriveResourceActions {

    private WebClient webClient;

    public DriveResourceActionsImpl(WebClient webClient) {
        this.webClient = webClient;
    }

    @Override
    public DriveResource update(URI driveUri, DriveUpdateDefinition driveUpdateDefinition)
            throws ExternalServiceApiActionException, ExternalServiceApiReaderException {

        return (DriveResource) webClient.patchAndRetrieve(driveUri, new DriveUpdateRequest(driveUpdateDefinition));
    }
