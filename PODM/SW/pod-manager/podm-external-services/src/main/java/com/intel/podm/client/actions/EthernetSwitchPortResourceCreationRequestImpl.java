...
public class EthernetSwitchPortResourceCreationRequestImpl implements EthernetSwitchPortResourceCreationRequest {
    ...
    @Override
    public void setPortMembers(Optional<List<URI>> uris) {
        ...
        if (ethernetSwitchPortLinks.getPortMembers() != null && ethernetSwitchPortLinks.getPortMembers().isPresent()) {
            links = of(ethernetSwitchPortLinks);
        }
    }
}
