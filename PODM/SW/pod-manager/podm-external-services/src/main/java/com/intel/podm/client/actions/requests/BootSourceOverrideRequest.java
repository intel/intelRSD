...
public class BootSourceOverrideRequest {

    @JsonProperty("Boot")
    private BootSourceOverride bootSourceOverride;

    public BootSourceOverrideRequest(BootSourceType bootSourceType, BootSourceState bootSourceState) {
        this.bootSourceOverride = new BootSourceOverride(bootSourceType, bootSourceState);
    }
    ...
    private class BootSourceOverride {
        ...
        BootSourceOverride(BootSourceType bootSourceType, BootSourceState bootSourceState) {
