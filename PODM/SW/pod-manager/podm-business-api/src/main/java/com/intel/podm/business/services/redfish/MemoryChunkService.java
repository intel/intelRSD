...
public interface MemoryChunkService {
    CollectionDto getMemoryChunkCollection(Context systemContext) throws EntityNotFoundException;
    MemoryChunkDto getMemoryChunk(Context memoryChunkContext) throws EntityNotFoundException;
}
