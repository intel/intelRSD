...
public final class ThermalTemperatureDto {

    private final String memberId;
    private final String name;
    private final Integer sensorNumber;
    private final Status status;
    private final BigDecimal readingCelsius;
    ...
    private ThermalTemperatureDto(Builder builder) {
        this.memberId = builder.memberId;
        this.name = builder.name;
        this.sensorNumber = builder.sensorNumber;
        this.status = builder.status;
        this.readingCelsius = builder.readingCelsius;
    ...
    public static Builder newThermalTemperatureDto() {
        return new Builder();
    }
    ...
    public static final class Builder {
        ...
        public ThermalTemperatureDto build() {
            return new ThermalTemperatureDto(this);
        }
        ...
        public Builder readingCelsius(BigDecimal readingCelsius) {
