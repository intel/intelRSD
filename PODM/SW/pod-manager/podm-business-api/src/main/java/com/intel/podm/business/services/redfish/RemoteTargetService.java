...
public interface RemoteTargetService {
    CollectionDto getRemoteTargetsCollection(Context serviceContext) throws EntityNotFoundException;
    RemoteTargetDto getRemoteTarget(Context remoteTargetContext) throws EntityNotFoundException;
}
