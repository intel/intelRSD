...
public interface SimpleStorageService {
    CollectionDto getSimpleStorageCollection(Context context) throws EntityNotFoundException;
    SimpleStorageDto getSimpleStorage(Context context) throws EntityNotFoundException;
}
