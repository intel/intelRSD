...
public class OnDeletePowerZone implements OnDeleteHook {
    ...
    public void execute(DomainObject domainObject) {
        PowerZone powerZone = (PowerZone) domainObject;
        powerZone.getPowerSupplies().forEach(genericDao::remove);
    }

    @Override
    public boolean canExecute(DomainObject domainObject) {
        return domainObject instanceof PowerZone;
    }
}
