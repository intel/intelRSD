...
public interface DomainObjectObtainerHelper<T extends ExternalServiceResource> {
    ComputerSystemResource findComputerSystemResourceFor(T resource) throws ExternalServiceApiReaderException;
    Optional<? extends DomainObject> findDomainObjectFor(ComputerSystem computerSystem, T resource);
