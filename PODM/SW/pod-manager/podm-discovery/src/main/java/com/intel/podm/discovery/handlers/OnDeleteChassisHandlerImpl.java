...
import com.intel.podm.business.entities.handlers.OnDeleteChassisHandler;
...
public class OnDeleteChassisHandlerImpl implements OnDeleteChassisHandler {
    @Inject
    ...
    private boolean parentChassisShouldBeDeleted(Chassis parentChassis) {
        return parentChassis != null
            && containsLessThanTwoChassis(parentChassis)
            && isNotOwnedByAnyService(parentChassis);
    }
