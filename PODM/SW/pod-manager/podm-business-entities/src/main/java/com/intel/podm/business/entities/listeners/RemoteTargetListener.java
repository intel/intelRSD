...
@ApplicationScoped
public class RemoteTargetListener extends EntityListener {
    @PreRemove
    public void preRemove(RemoteTarget remoteTarget) {
        OnDeleteRemoteTargetHandler onDeleteRemoteTargetHandler = create(OnDeleteRemoteTargetHandler.class);
        onDeleteRemoteTargetHandler.preRemove(remoteTarget);
    }
}
