...
@Dependent
public class PowerZoneListener extends EntityListener {
    @PreRemove
    public void preRemove(PowerZone powerZone) {
        OnDeletePowerZoneHandler onDeletePowerZoneHandler = create(OnDeletePowerZoneHandler.class);
        onDeletePowerZoneHandler.preRemove(powerZone);
    }
}
