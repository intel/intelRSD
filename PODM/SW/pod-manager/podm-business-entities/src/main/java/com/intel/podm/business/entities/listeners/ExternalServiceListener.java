...
public class ExternalServiceListener extends EntityListener {
    ...
    public void preRemove(ExternalService externalService) {
        OnDeleteExternalServiceHandler onDeleteExternalServiceHandler = create(OnDeleteExternalServiceHandler.class);
        onDeleteExternalServiceHandler.preRemove(externalService);
        beanManager.fireEvent(externalServiceRemoved(externalService));
    }
}
