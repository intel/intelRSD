...
public class Console extends DomainObject {
    ...
    public static final DomainObjectProperty<EnumeratedTypeListHolder<GeneralConnectType>> CONNECT_TYPES_SUPPORTED =
            DomainObjectProperties.enumeratedTypeListProperty("connectTypesSupported", GeneralConnectType.class);
    ...
    public List<GeneralConnectType> getConnectTypesSupported() {
        return toList(GeneralConnectType.class, getProperty(CONNECT_TYPES_SUPPORTED));
    }

    public void setConnectTypesSupported(List<GeneralConnectType> connectTypesSupported) {
        setProperty(CONNECT_TYPES_SUPPORTED, enumeratedTypeListHolder(GeneralConnectType.class, connectTypesSupported));
    }
}
