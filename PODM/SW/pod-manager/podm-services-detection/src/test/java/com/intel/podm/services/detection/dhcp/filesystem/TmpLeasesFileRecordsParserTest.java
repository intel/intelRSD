...
public class TmpLeasesFileRecordsParserTest {
    ...
    static class TestData {
        static final TmpLeasesRecord VALID_PSME_CANDIDATE = new TmpLeasesRecord(PSME, "10.0.0.1", "2015-11-01T00:01:00.123456");
        static final TmpLeasesRecord VALID_RSS_CANDIDATE = new TmpLeasesRecord(RSS, "10.0.0.2", "2015-11-01T00:02:00.123456");
        static final TmpLeasesRecord VALID_RMM_CANDIDATE = new TmpLeasesRecord(RMM, "10.0.0.3", "2015-11-01T00:03:00.123456");
        static final TmpLeasesRecord VALID_LUI_CANDIDATE = new TmpLeasesRecord(LUI, "10.0.0.4", "2015-11-01T00:04:00.123456");
