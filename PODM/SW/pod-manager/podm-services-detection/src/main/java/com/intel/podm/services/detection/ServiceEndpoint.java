...
public final class ServiceEndpoint {
    ...
    public ServiceEndpoint(ServiceType serviceType, UUID serviceUuid, URI endpointUri, MacAddress macAddress) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getServiceType(), endpoint.getServiceType())
                ...
                && Objects.equals(getMacAddress(), endpoint.getMacAddress());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getServiceType(), getServiceUuid(), getMacAddress());
    }

    @Override
    public String toString() {
        return format("{URI=%s, type=%s, UUID=%s, MAC=%s}", endpointUri, serviceType, serviceUuid, macAddress);
    }
}
