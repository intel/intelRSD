...
@Dependent
public class NetworkInterfaceDtoMapper extends DtoMapper<NetworkInterface, NetworkInterfaceDto> {
    NetworkInterfaceDtoMapper() {
        super(NetworkInterface.class, NetworkInterfaceDto.class);
    }
}
