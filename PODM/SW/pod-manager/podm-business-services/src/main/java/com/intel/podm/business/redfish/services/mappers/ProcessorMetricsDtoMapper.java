...
@Dependent
class ProcessorMetricsDtoMapper extends DtoMapper<ProcessorMetrics, ProcessorMetricsDto> {
    ProcessorMetricsDtoMapper() {
        super(ProcessorMetrics.class, ProcessorMetricsDto.class);
    }
}
