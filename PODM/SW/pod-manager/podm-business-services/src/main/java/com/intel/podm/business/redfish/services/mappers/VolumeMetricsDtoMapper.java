...
@Dependent
public class VolumeMetricsDtoMapper extends DtoMapper<VolumeMetrics, VolumeMetricsDto> {

    public VolumeMetricsDtoMapper() {
        super(VolumeMetrics.class, VolumeMetricsDto.class);
    }
}
