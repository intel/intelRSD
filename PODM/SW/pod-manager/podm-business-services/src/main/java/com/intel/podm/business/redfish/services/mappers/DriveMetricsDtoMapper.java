...
@Dependent
public class DriveMetricsDtoMapper extends DtoMapper<DriveMetrics, DriveMetricsDto> {
    public DriveMetricsDtoMapper() {
        super(DriveMetrics.class, DriveMetricsDto.class);
    }
}
