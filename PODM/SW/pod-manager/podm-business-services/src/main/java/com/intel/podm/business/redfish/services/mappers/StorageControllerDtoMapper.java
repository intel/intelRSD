...
@Dependent
class StorageControllerDtoMapper extends DtoMapper<StorageController, StorageControllerDto> {
    StorageControllerDtoMapper() {
        super(StorageController.class, StorageControllerDto.class);
    }
}
