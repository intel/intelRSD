...
@Dependent
class ApplicationProtocolDtoMapper extends BrilliantMapper<ApplicationProtocolType, ApplicationProtocolDto> {

    ApplicationProtocolDtoMapper() {
        super(ApplicationProtocolType.class, ApplicationProtocolDto.class);
    }
}
