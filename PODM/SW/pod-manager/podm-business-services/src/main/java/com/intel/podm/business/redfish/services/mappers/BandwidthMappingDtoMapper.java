...
@Dependent
class BandwidthMappingDtoMapper extends BrilliantMapper<BandwidthMapping, BandwidthMappingDto> {

    BandwidthMappingDtoMapper() {
        super(BandwidthMapping.class, BandwidthMappingDto.class);
    }
}
