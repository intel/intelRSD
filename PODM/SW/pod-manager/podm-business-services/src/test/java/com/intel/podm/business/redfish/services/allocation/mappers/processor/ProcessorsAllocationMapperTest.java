...
public class ProcessorsAllocationMapperTest {
    ...
    @Test
    public void whenMappingRequestedProcessorWithoutInstructionSet_shouldMapToAnyOfAvailableProcessors() {
        List<RequestedNode.Processor> requestedProcessors = singletonList(
            createRequestedProcessor(null, null, null, null, null, null, null)
        );
        ...
        List<Processor> availableProcessors = asList(
            ...
            createAvailableProcessor("Multi-Core Intel(R) Xeon(R) processor 7xxx Series", X7, 503, X86, 11, id(3)),
            createAvailableProcessor("Multi-Core Intel(R) Xeon(R) processor 7xxx Series", X7, 502, X86, 10, id(4)),
            createAvailableProcessor("Multi-Core Intel(R) Xeon(R) processor 7xxx Series", X7, 502, null, 10, id(4)),
            createAvailableProcessor(null, null, null, null, null, null)
        );
