...
public interface NetworkDeviceFunctionActions extends AutoCloseable {
    NetworkDeviceFunctionResource update(URI networkDeviceFunctionUri, NetworkDeviceFunctionUpdateDefinition updateDefinition)
