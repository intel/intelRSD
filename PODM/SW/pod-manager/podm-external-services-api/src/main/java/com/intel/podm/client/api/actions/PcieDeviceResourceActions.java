...
public interface PcieDeviceResourceActions extends AutoCloseable {
    PcieDeviceResource update(URI pcieDeviceUri, PcieDeviceUpdateDefinition pcieDeviceUpdateDefinition)
