...
public interface EthernetSwitchPortVlanResourceActions extends AutoCloseable {
    URI createVlan(URI switchPortUri, int vlanId, boolean tagged, boolean enabled) throws ExternalServiceApiActionException;
