...
public interface RemoteTargetResourceActions extends AutoCloseable {
    RemoteTargetResource update(URI remoteTargetUri, RemoteTargetUpdateDefinition remoteTargetUpdateDefinition)
