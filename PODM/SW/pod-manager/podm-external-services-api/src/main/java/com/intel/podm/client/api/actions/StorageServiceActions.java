...
public interface StorageServiceActions extends AutoCloseable {
     ...
     */
    URI createBootableLogicalDrive(URI storageServiceUri, LogicalDriveResourceCreationRequest request)
            throws ExternalServiceApiActionException, InterruptedException;

    /**
     * @throws ExternalServiceApiActionException, InterruptedException
     */
    URI createLogicalDrive(URI storageServiceUri, LogicalDriveResourceCreationRequest request)
            throws ExternalServiceApiActionException, InterruptedException;
