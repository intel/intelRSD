...
public interface ChassisResourceActions extends AutoCloseable {
    ChassisResource update(URI chassisUri, BaseChassisUpdateDefinition chassisUpdateDefinition)
            throws ExternalServiceApiActionException, ExternalServiceApiReaderException;
    ChassisResource get(URI chassisUri) throws ExternalServiceApiReaderException;
