...
public interface StorageServiceResource extends ExternalServiceResource {
    Status getStatus();
    ...
    Iterable<ResourceSupplier> getRemoteTargets() throws ExternalServiceApiReaderException;
