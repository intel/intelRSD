...
public interface FabricResource extends ExternalServiceResource {

    Protocol getFabricType();

    Integer getMaxZones();

    Status getStatus();

    Iterable<ResourceSupplier> getZones() throws ExternalServiceApiReaderException;
